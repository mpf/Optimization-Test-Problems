...
minimize obj:
	...
	5.0d-1*(y9_9_10 - 1.0)*(y9_9_10 - 1.0) + 5.0d-1*(y0_1_1 - 1.0)*(y0_1_1 - 1.0) +
	5.0d-1*(z0_1_1 - 1.0)*(z0_1_1 - 1.0) + 5.0d-1*(y11_1_1 - 1.0)*(y11_1_1 - 1.0) +
	5.0d-1*(z11_1_1 - 1.0)*(z11_1_1 - 1.0) + 5.0d-1*(y0_2_1 - 1.0)*(y0_2_1 - 1.0) +
	5.0d-1*(z0_2_1 - 1.0)*(z0_2_1 - 1.0) + 5.0d-1*(y11_2_1 - 1.0)*(y11_2_1 - 1.0) +
	5.0d-1*(z11_2_1 - 1.0)*(z11_2_1 - 1.0) + 5.0d-1*(y0_3_1 - 1.0)*(y0_3_1 - 1.0) +
	5.0d-1*(z0_3_1 - 1.0)*(z0_3_1 - 1.0) + 5.0d-1*(y11_3_1 - 1.0)*(y11_3_1 - 1.0) +
	5.0d-1*(z11_3_1 - 1.0)*(z11_3_1 - 1.0) + 5.0d-1*(y0_4_1 - 1.0)*(y0_4_1 - 1.0) +
	5.0d-1*(z0_4_1 - 1.0)*(z0_4_1 - 1.0) + 5.0d-1*(y11_4_1 - 1.0)*(y11_4_1 - 1.0) +
	5.0d-1*(z11_4_1 - 1.0)*(z11_4_1 - 1.0) + 5.0d-1*(y0_5_1 - 1.0)*(y0_5_1 - 1.0) +
	5.0d-1*(z0_5_1 - 1.0)*(z0_5_1 - 1.0) + 5.0d-1*(y11_5_1 - 1.0)*(y11_5_1 - 1.0) +
	5.0d-1*(z11_5_1 - 1.0)*(z11_5_1 - 1.0) + 5.0d-1*(y0_6_1 - 1.0)*(y0_6_1 - 1.0) +
	5.0d-1*(z0_6_1 - 1.0)*(z0_6_1 - 1.0) + 5.0d-1*(y11_6_1 - 1.0)*(y11_6_1 - 1.0) +
	5.0d-1*(z11_6_1 - 1.0)*(z11_6_1 - 1.0) + 5.0d-1*(y0_7_1 - 1.0)*(y0_7_1 - 1.0) +
	5.0d-1*(z0_7_1 - 1.0)*(z0_7_1 - 1.0) + 5.0d-1*(y11_7_1 - 1.0)*(y11_7_1 - 1.0) +
	5.0d-1*(z11_7_1 - 1.0)*(z11_7_1 - 1.0) + 5.0d-1*(y0_8_1 - 1.0)*(y0_8_1 - 1.0) +
	5.0d-1*(z0_8_1 - 1.0)*(z0_8_1 - 1.0) + 5.0d-1*(y11_8_1 - 1.0)*(y11_8_1 - 1.0) +
	5.0d-1*(z11_8_1 - 1.0)*(z11_8_1 - 1.0) + 5.0d-1*(y0_9_1 - 1.0)*(y0_9_1 - 1.0) +
	5.0d-1*(z0_9_1 - 1.0)*(z0_9_1 - 1.0) + 5.0d-1*(y11_9_1 - 1.0)*(y11_9_1 - 1.0) +
	5.0d-1*(z11_9_1 - 1.0)*(z11_9_1 - 1.0) + 5.0d-1*(y0_10_1 - 1.0)*(y0_10_1 - 1.0)
	+ 5.0d-1*(z0_10_1 - 1.0)*(z0_10_1 - 1.0) + 5.0d-1*(y11_10_1 - 1.0)*(y11_10_1 -
	1.0) + 5.0d-1*(z11_10_1 - 1.0)*(z11_10_1 - 1.0) + 5.0d-1*(y0_1_2 - 1.0)*(y0_1_2
	- 1.0) + 5.0d-1*(z0_1_2 - 1.0)*(z0_1_2 - 1.0) + 5.0d-1*(y11_1_2 - 1.0)*(y11_1_2
	- 1.0) + 5.0d-1*(z11_1_2 - 1.0)*(z11_1_2 - 1.0) + 5.0d-1*(y0_2_2 - 1.0)*(y0_2_2
	- 1.0) + 5.0d-1*(z0_2_2 - 1.0)*(z0_2_2 - 1.0) + 5.0d-1*(y11_2_2 - 1.0)*(y11_2_2
	- 1.0) + 5.0d-1*(z11_2_2 - 1.0)*(z11_2_2 - 1.0) + 5.0d-1*(y0_3_2 - 1.0)*(y0_3_2
	- 1.0) + 5.0d-1*(z0_3_2 - 1.0)*(z0_3_2 - 1.0) + 5.0d-1*(y11_3_2 - 1.0)*(y11_3_2
	- 1.0) + 5.0d-1*(z11_3_2 - 1.0)*(z11_3_2 - 1.0) + 5.0d-1*(y0_4_2 - 1.0)*(y0_4_2
	- 1.0) + 5.0d-1*(z0_4_2 - 1.0)*(z0_4_2 - 1.0) + 5.0d-1*(y11_4_2 - 1.0)*(y11_4_2
	- 1.0) + 5.0d-1*(z11_4_2 - 1.0)*(z11_4_2 - 1.0) + 5.0d-1*(y0_5_2 - 1.0)*(y0_5_2
	- 1.0) + 5.0d-1*(z0_5_2 - 1.0)*(z0_5_2 - 1.0) + 5.0d-1*(y11_5_2 - 1.0)*(y11_5_2
	- 1.0) + 5.0d-1*(z11_5_2 - 1.0)*(z11_5_2 - 1.0) + 5.0d-1*(y0_6_2 - 1.0)*(y0_6_2
	- 1.0) + 5.0d-1*(z0_6_2 - 1.0)*(z0_6_2 - 1.0) + 5.0d-1*(y11_6_2 - 1.0)*(y11_6_2
	- 1.0) + 5.0d-1*(z11_6_2 - 1.0)*(z11_6_2 - 1.0) + 5.0d-1*(y0_7_2 - 1.0)*(y0_7_2
	- 1.0) + 5.0d-1*(z0_7_2 - 1.0)*(z0_7_2 - 1.0) + 5.0d-1*(y11_7_2 - 1.0)*(y11_7_2
	- 1.0) + 5.0d-1*(z11_7_2 - 1.0)*(z11_7_2 - 1.0) + 5.0d-1*(y0_8_2 - 1.0)*(y0_8_2
	- 1.0) + 5.0d-1*(z0_8_2 - 1.0)*(z0_8_2 - 1.0) + 5.0d-1*(y11_8_2 - 1.0)*(y11_8_2
	- 1.0) + 5.0d-1*(z11_8_2 - 1.0)*(z11_8_2 - 1.0) + 5.0d-1*(y0_9_2 - 1.0)*(y0_9_2
	- 1.0) + 5.0d-1*(z0_9_2 - 1.0)*(z0_9_2 - 1.0) + 5.0d-1*(y11_9_2 - 1.0)*(y11_9_2
	- 1.0) + 5.0d-1*(z11_9_2 - 1.0)*(z11_9_2 - 1.0) + 5.0d-1*(y0_10_2 -
	1.0)*(y0_10_2 - 1.0) + 5.0d-1*(z0_10_2 - 1.0)*(z0_10_2 - 1.0) +
	5.0d-1*(y11_10_2 - 1.0)*(y11_10_2 - 1.0) + 5.0d-1*(z11_10_2 - 1.0)*(z11_10_2 -
	1.0) + 5.0d-1*(y0_1_3 - 1.0)*(y0_1_3 - 1.0) + 5.0d-1*(z0_1_3 - 1.0)*(z0_1_3 -
	1.0) + 5.0d-1*(y11_1_3 - 1.0)*(y11_1_3 - 1.0) + 5.0d-1*(z11_1_3 - 1.0)*(z11_1_3
	- 1.0) + 5.0d-1*(y0_2_3 - 1.0)*(y0_2_3 - 1.0) + 5.0d-1*(z0_2_3 - 1.0)*(z0_2_3 -
	1.0) + 5.0d-1*(y11_2_3 - 1.0)*(y11_2_3 - 1.0) + 5.0d-1*(z11_2_3 - 1.0)*(z11_2_3
	- 1.0) + 5.0d-1*(y0_3_3 - 1.0)*(y0_3_3 - 1.0) + 5.0d-1*(z0_3_3 - 1.0)*(z0_3_3 -
	1.0) + 5.0d-1*(y11_3_3 - 1.0)*(y11_3_3 - 1.0) + 5.0d-1*(z11_3_3 - 1.0)*(z11_3_3
	- 1.0) + 5.0d-1*(y0_4_3 - 1.0)*(y0_4_3 - 1.0) + 5.0d-1*(z0_4_3 - 1.0)*(z0_4_3 -
	1.0) + 5.0d-1*(y11_4_3 - 1.0)*(y11_4_3 - 1.0) + 5.0d-1*(z11_4_3 - 1.0)*(z11_4_3
	- 1.0) + 5.0d-1*(y0_5_3 - 1.0)*(y0_5_3 - 1.0) + 5.0d-1*(z0_5_3 - 1.0)*(z0_5_3 -
	1.0) + 5.0d-1*(y11_5_3 - 1.0)*(y11_5_3 - 1.0) + 5.0d-1*(z11_5_3 - 1.0)*(z11_5_3
	- 1.0) + 5.0d-1*(y0_6_3 - 1.0)*(y0_6_3 - 1.0) + 5.0d-1*(z0_6_3 - 1.0)*(z0_6_3 -
	1.0) + 5.0d-1*(y11_6_3 - 1.0)*(y11_6_3 - 1.0) + 5.0d-1*(z11_6_3 - 1.0)*(z11_6_3
	- 1.0) + 5.0d-1*(y0_7_3 - 1.0)*(y0_7_3 - 1.0) + 5.0d-1*(z0_7_3 - 1.0)*(z0_7_3 -
	1.0) + 5.0d-1*(y11_7_3 - 1.0)*(y11_7_3 - 1.0) + 5.0d-1*(z11_7_3 - 1.0)*(z11_7_3
	- 1.0) + 5.0d-1*(y0_8_3 - 1.0)*(y0_8_3 - 1.0) + 5.0d-1*(z0_8_3 - 1.0)*(z0_8_3 -
	1.0) + 5.0d-1*(y11_8_3 - 1.0)*(y11_8_3 - 1.0) + 5.0d-1*(z11_8_3 - 1.0)*(z11_8_3
	- 1.0) + 5.0d-1*(y0_9_3 - 1.0)*(y0_9_3 - 1.0) + 5.0d-1*(z0_9_3 - 1.0)*(z0_9_3 -
	1.0) + 5.0d-1*(y11_9_3 - 1.0)*(y11_9_3 - 1.0) + 5.0d-1*(z11_9_3 - 1.0)*(z11_9_3
	- 1.0) + 5.0d-1*(y0_10_3 - 1.0)*(y0_10_3 - 1.0) + 5.0d-1*(z0_10_3 -
	1.0)*(z0_10_3 - 1.0) + 5.0d-1*(y11_10_3 - 1.0)*(y11_10_3 - 1.0) +
	5.0d-1*(z11_10_3 - 1.0)*(z11_10_3 - 1.0) + 5.0d-1*(y0_1_4 - 1.0)*(y0_1_4 - 1.0)
	+ 5.0d-1*(z0_1_4 - 1.0)*(z0_1_4 - 1.0) + 5.0d-1*(y11_1_4 - 1.0)*(y11_1_4 - 1.0)
	+ 5.0d-1*(z11_1_4 - 1.0)*(z11_1_4 - 1.0) + 5.0d-1*(y0_2_4 - 1.0)*(y0_2_4 - 1.0)
	+ 5.0d-1*(z0_2_4 - 1.0)*(z0_2_4 - 1.0) + 5.0d-1*(y11_2_4 - 1.0)*(y11_2_4 - 1.0)
	+ 5.0d-1*(z11_2_4 - 1.0)*(z11_2_4 - 1.0) + 5.0d-1*(y0_3_4 - 1.0)*(y0_3_4 - 1.0)
	+ 5.0d-1*(z0_3_4 - 1.0)*(z0_3_4 - 1.0) + 5.0d-1*(y11_3_4 - 1.0)*(y11_3_4 - 1.0)
	+ 5.0d-1*(z11_3_4 - 1.0)*(z11_3_4 - 1.0) + 5.0d-1*(y0_4_4 - 1.0)*(y0_4_4 - 1.0)
	+ 5.0d-1*(z0_4_4 - 1.0)*(z0_4_4 - 1.0) + 5.0d-1*(y11_4_4 - 1.0)*(y11_4_4 - 1.0)
	+ 5.0d-1*(z11_4_4 - 1.0)*(z11_4_4 - 1.0) + 5.0d-1*(y0_5_4 - 1.0)*(y0_5_4 - 1.0)
	+ 5.0d-1*(z0_5_4 - 1.0)*(z0_5_4 - 1.0) + 5.0d-1*(y11_5_4 - 1.0)*(y11_5_4 - 1.0)
	+ 5.0d-1*(z11_5_4 - 1.0)*(z11_5_4 - 1.0) + 5.0d-1*(y0_6_4 - 1.0)*(y0_6_4 - 1.0)
	+ 5.0d-1*(z0_6_4 - 1.0)*(z0_6_4 - 1.0) + 5.0d-1*(y11_6_4 - 1.0)*(y11_6_4 - 1.0)
	+ 5.0d-1*(z11_6_4 - 1.0)*(z11_6_4 - 1.0) + 5.0d-1*(y0_7_4 - 1.0)*(y0_7_4 - 1.0)
	+ 5.0d-1*(z0_7_4 - 1.0)*(z0_7_4 - 1.0) + 5.0d-1*(y11_7_4 - 1.0)*(y11_7_4 - 1.0)
	+ 5.0d-1*(z11_7_4 - 1.0)*(z11_7_4 - 1.0) + 5.0d-1*(y0_8_4 - 1.0)*(y0_8_4 - 1.0)
	+ 5.0d-1*(z0_8_4 - 1.0)*(z0_8_4 - 1.0) + 5.0d-1*(y11_8_4 - 1.0)*(y11_8_4 - 1.0)
	+ 5.0d-1*(z11_8_4 - 1.0)*(z11_8_4 - 1.0) + 5.0d-1*(y0_9_4 - 1.0)*(y0_9_4 - 1.0)
	+ 5.0d-1*(z0_9_4 - 1.0)*(z0_9_4 - 1.0) + 5.0d-1*(y11_9_4 - 1.0)*(y11_9_4 - 1.0)
	+ 5.0d-1*(z11_9_4 - 1.0)*(z11_9_4 - 1.0) + 5.0d-1*(y0_10_4 - 1.0)*(y0_10_4 -
	1.0) + 5.0d-1*(z0_10_4 - 1.0)*(z0_10_4 - 1.0) + 5.0d-1*(y11_10_4 -
	1.0)*(y11_10_4 - 1.0) + 5.0d-1*(z11_10_4 - 1.0)*(z11_10_4 - 1.0) +
	5.0d-1*(y0_1_5 - 1.0)*(y0_1_5 - 1.0) + 5.0d-1*(z0_1_5 - 1.0)*(z0_1_5 - 1.0) +
	5.0d-1*(y11_1_5 - 1.0)*(y11_1_5 - 1.0) + 5.0d-1*(z11_1_5 - 1.0)*(z11_1_5 - 1.0)
	+ 5.0d-1*(y0_2_5 - 1.0)*(y0_2_5 - 1.0) + 5.0d-1*(z0_2_5 - 1.0)*(z0_2_5 - 1.0) +
	5.0d-1*(y11_2_5 - 1.0)*(y11_2_5 - 1.0) + 5.0d-1*(z11_2_5 - 1.0)*(z11_2_5 - 1.0)
	+ 5.0d-1*(y0_3_5 - 1.0)*(y0_3_5 - 1.0) + 5.0d-1*(z0_3_5 - 1.0)*(z0_3_5 - 1.0) +
	5.0d-1*(y11_3_5 - 1.0)*(y11_3_5 - 1.0) + 5.0d-1*(z11_3_5 - 1.0)*(z11_3_5 - 1.0)
	+ 5.0d-1*(y0_4_5 - 1.0)*(y0_4_5 - 1.0) + 5.0d-1*(z0_4_5 - 1.0)*(z0_4_5 - 1.0) +
	5.0d-1*(y11_4_5 - 1.0)*(y11_4_5 - 1.0) + 5.0d-1*(z11_4_5 - 1.0)*(z11_4_5 - 1.0)
	+ 5.0d-1*(y0_5_5 - 1.0)*(y0_5_5 - 1.0) + 5.0d-1*(z0_5_5 - 1.0)*(z0_5_5 - 1.0) +
	5.0d-1*(y11_5_5 - 1.0)*(y11_5_5 - 1.0) + 5.0d-1*(z11_5_5 - 1.0)*(z11_5_5 - 1.0)
	+ 5.0d-1*(y0_6_5 - 1.0)*(y0_6_5 - 1.0) + 5.0d-1*(z0_6_5 - 1.0)*(z0_6_5 - 1.0) +
	5.0d-1*(y11_6_5 - 1.0)*(y11_6_5 - 1.0) + 5.0d-1*(z11_6_5 - 1.0)*(z11_6_5 - 1.0)
	+ 5.0d-1*(y0_7_5 - 1.0)*(y0_7_5 - 1.0) + 5.0d-1*(z0_7_5 - 1.0)*(z0_7_5 - 1.0) +
	5.0d-1*(y11_7_5 - 1.0)*(y11_7_5 - 1.0) + 5.0d-1*(z11_7_5 - 1.0)*(z11_7_5 - 1.0)
	+ 5.0d-1*(y0_8_5 - 1.0)*(y0_8_5 - 1.0) + 5.0d-1*(z0_8_5 - 1.0)*(z0_8_5 - 1.0) +
	5.0d-1*(y11_8_5 - 1.0)*(y11_8_5 - 1.0) + 5.0d-1*(z11_8_5 - 1.0)*(z11_8_5 - 1.0)
	+ 5.0d-1*(y0_9_5 - 1.0)*(y0_9_5 - 1.0) + 5.0d-1*(z0_9_5 - 1.0)*(z0_9_5 - 1.0) +
	5.0d-1*(y11_9_5 - 1.0)*(y11_9_5 - 1.0) + 5.0d-1*(z11_9_5 - 1.0)*(z11_9_5 - 1.0)
	+ 5.0d-1*(y0_10_5 - 1.0)*(y0_10_5 - 1.0) + 5.0d-1*(z0_10_5 - 1.0)*(z0_10_5 -
	1.0) + 5.0d-1*(y11_10_5 - 1.0)*(y11_10_5 - 1.0) + 5.0d-1*(z11_10_5 -
	1.0)*(z11_10_5 - 1.0) + 5.0d-1*(y0_1_6 - 1.0)*(y0_1_6 - 1.0) + 5.0d-1*(z0_1_6 -
	1.0)*(z0_1_6 - 1.0) + 5.0d-1*(y11_1_6 - 1.0)*(y11_1_6 - 1.0) + 5.0d-1*(z11_1_6
	- 1.0)*(z11_1_6 - 1.0) + 5.0d-1*(y0_2_6 - 1.0)*(y0_2_6 - 1.0) + 5.0d-1*(z0_2_6
	- 1.0)*(z0_2_6 - 1.0) + 5.0d-1*(y11_2_6 - 1.0)*(y11_2_6 - 1.0) +
	5.0d-1*(z11_2_6 - 1.0)*(z11_2_6 - 1.0) + 5.0d-1*(y0_3_6 - 1.0)*(y0_3_6 - 1.0) +
	5.0d-1*(z0_3_6 - 1.0)*(z0_3_6 - 1.0) + 5.0d-1*(y11_3_6 - 1.0)*(y11_3_6 - 1.0) +
	5.0d-1*(z11_3_6 - 1.0)*(z11_3_6 - 1.0) + 5.0d-1*(y0_4_6 - 1.0)*(y0_4_6 - 1.0) +
	5.0d-1*(z0_4_6 - 1.0)*(z0_4_6 - 1.0) + 5.0d-1*(y11_4_6 - 1.0)*(y11_4_6 - 1.0) +
	5.0d-1*(z11_4_6 - 1.0)*(z11_4_6 - 1.0) + 5.0d-1*(y0_5_6 - 1.0)*(y0_5_6 - 1.0) +
	5.0d-1*(z0_5_6 - 1.0)*(z0_5_6 - 1.0) + 5.0d-1*(y11_5_6 - 1.0)*(y11_5_6 - 1.0) +
	5.0d-1*(z11_5_6 - 1.0)*(z11_5_6 - 1.0) + 5.0d-1*(y0_6_6 - 1.0)*(y0_6_6 - 1.0) +
	5.0d-1*(z0_6_6 - 1.0)*(z0_6_6 - 1.0) + 5.0d-1*(y11_6_6 - 1.0)*(y11_6_6 - 1.0) +
	5.0d-1*(z11_6_6 - 1.0)*(z11_6_6 - 1.0) + 5.0d-1*(y0_7_6 - 1.0)*(y0_7_6 - 1.0) +
	5.0d-1*(z0_7_6 - 1.0)*(z0_7_6 - 1.0) + 5.0d-1*(y11_7_6 - 1.0)*(y11_7_6 - 1.0) +
	5.0d-1*(z11_7_6 - 1.0)*(z11_7_6 - 1.0) + 5.0d-1*(y0_8_6 - 1.0)*(y0_8_6 - 1.0) +
	5.0d-1*(z0_8_6 - 1.0)*(z0_8_6 - 1.0) + 5.0d-1*(y11_8_6 - 1.0)*(y11_8_6 - 1.0) +
	5.0d-1*(z11_8_6 - 1.0)*(z11_8_6 - 1.0) + 5.0d-1*(y0_9_6 - 1.0)*(y0_9_6 - 1.0) +
	5.0d-1*(z0_9_6 - 1.0)*(z0_9_6 - 1.0) + 5.0d-1*(y11_9_6 - 1.0)*(y11_9_6 - 1.0) +
	5.0d-1*(z11_9_6 - 1.0)*(z11_9_6 - 1.0) + 5.0d-1*(y0_10_6 - 1.0)*(y0_10_6 - 1.0)
	+ 5.0d-1*(z0_10_6 - 1.0)*(z0_10_6 - 1.0) + 5.0d-1*(y11_10_6 - 1.0)*(y11_10_6 -
	1.0) + 5.0d-1*(z11_10_6 - 1.0)*(z11_10_6 - 1.0) + 5.0d-1*(y0_1_7 - 1.0)*(y0_1_7
	- 1.0) + 5.0d-1*(z0_1_7 - 1.0)*(z0_1_7 - 1.0) + 5.0d-1*(y11_1_7 - 1.0)*(y11_1_7
	- 1.0) + 5.0d-1*(z11_1_7 - 1.0)*(z11_1_7 - 1.0) + 5.0d-1*(y0_2_7 - 1.0)*(y0_2_7
	- 1.0) + 5.0d-1*(z0_2_7 - 1.0)*(z0_2_7 - 1.0) + 5.0d-1*(y11_2_7 - 1.0)*(y11_2_7
	- 1.0) + 5.0d-1*(z11_2_7 - 1.0)*(z11_2_7 - 1.0) + 5.0d-1*(y0_3_7 - 1.0)*(y0_3_7
	- 1.0) + 5.0d-1*(z0_3_7 - 1.0)*(z0_3_7 - 1.0) + 5.0d-1*(y11_3_7 - 1.0)*(y11_3_7
	- 1.0) + 5.0d-1*(z11_3_7 - 1.0)*(z11_3_7 - 1.0) + 5.0d-1*(y0_4_7 - 1.0)*(y0_4_7
	- 1.0) + 5.0d-1*(z0_4_7 - 1.0)*(z0_4_7 - 1.0) + 5.0d-1*(y11_4_7 - 1.0)*(y11_4_7
	- 1.0) + 5.0d-1*(z11_4_7 - 1.0)*(z11_4_7 - 1.0) + 5.0d-1*(y0_5_7 - 1.0)*(y0_5_7
	- 1.0) + 5.0d-1*(z0_5_7 - 1.0)*(z0_5_7 - 1.0) + 5.0d-1*(y11_5_7 - 1.0)*(y11_5_7
	- 1.0) + 5.0d-1*(z11_5_7 - 1.0)*(z11_5_7 - 1.0) + 5.0d-1*(y0_6_7 - 1.0)*(y0_6_7
	- 1.0) + 5.0d-1*(z0_6_7 - 1.0)*(z0_6_7 - 1.0) + 5.0d-1*(y11_6_7 - 1.0)*(y11_6_7
	- 1.0) + 5.0d-1*(z11_6_7 - 1.0)*(z11_6_7 - 1.0) + 5.0d-1*(y0_7_7 - 1.0)*(y0_7_7
	- 1.0) + 5.0d-1*(z0_7_7 - 1.0)*(z0_7_7 - 1.0) + 5.0d-1*(y11_7_7 - 1.0)*(y11_7_7
	- 1.0) + 5.0d-1*(z11_7_7 - 1.0)*(z11_7_7 - 1.0) + 5.0d-1*(y0_8_7 - 1.0)*(y0_8_7
	- 1.0) + 5.0d-1*(z0_8_7 - 1.0)*(z0_8_7 - 1.0) + 5.0d-1*(y11_8_7 - 1.0)*(y11_8_7
	- 1.0) + 5.0d-1*(z11_8_7 - 1.0)*(z11_8_7 - 1.0) + 5.0d-1*(y0_9_7 - 1.0)*(y0_9_7
	- 1.0) + 5.0d-1*(z0_9_7 - 1.0)*(z0_9_7 - 1.0) + 5.0d-1*(y11_9_7 - 1.0)*(y11_9_7
	- 1.0) + 5.0d-1*(z11_9_7 - 1.0)*(z11_9_7 - 1.0) + 5.0d-1*(y0_10_7 -
	1.0)*(y0_10_7 - 1.0) + 5.0d-1*(z0_10_7 - 1.0)*(z0_10_7 - 1.0) +
	5.0d-1*(y11_10_7 - 1.0)*(y11_10_7 - 1.0) + 5.0d-1*(z11_10_7 - 1.0)*(z11_10_7 -
	1.0) + 5.0d-1*(y0_1_8 - 1.0)*(y0_1_8 - 1.0) + 5.0d-1*(z0_1_8 - 1.0)*(z0_1_8 -
	1.0) + 5.0d-1*(y11_1_8 - 1.0)*(y11_1_8 - 1.0) + 5.0d-1*(z11_1_8 - 1.0)*(z11_1_8
	- 1.0) + 5.0d-1*(y0_2_8 - 1.0)*(y0_2_8 - 1.0) + 5.0d-1*(z0_2_8 - 1.0)*(z0_2_8 -
	1.0) + 5.0d-1*(y11_2_8 - 1.0)*(y11_2_8 - 1.0) + 5.0d-1*(z11_2_8 - 1.0)*(z11_2_8
	- 1.0) + 5.0d-1*(y0_3_8 - 1.0)*(y0_3_8 - 1.0) + 5.0d-1*(z0_3_8 - 1.0)*(z0_3_8 -
	1.0) + 5.0d-1*(y11_3_8 - 1.0)*(y11_3_8 - 1.0) + 5.0d-1*(z11_3_8 - 1.0)*(z11_3_8
	- 1.0) + 5.0d-1*(y0_4_8 - 1.0)*(y0_4_8 - 1.0) + 5.0d-1*(z0_4_8 - 1.0)*(z0_4_8 -
	1.0) + 5.0d-1*(y11_4_8 - 1.0)*(y11_4_8 - 1.0) + 5.0d-1*(z11_4_8 - 1.0)*(z11_4_8
	- 1.0) + 5.0d-1*(y0_5_8 - 1.0)*(y0_5_8 - 1.0) + 5.0d-1*(z0_5_8 - 1.0)*(z0_5_8 -
	1.0) + 5.0d-1*(y11_5_8 - 1.0)*(y11_5_8 - 1.0) + 5.0d-1*(z11_5_8 - 1.0)*(z11_5_8
	- 1.0) + 5.0d-1*(y0_6_8 - 1.0)*(y0_6_8 - 1.0) + 5.0d-1*(z0_6_8 - 1.0)*(z0_6_8 -
	1.0) + 5.0d-1*(y11_6_8 - 1.0)*(y11_6_8 - 1.0) + 5.0d-1*(z11_6_8 - 1.0)*(z11_6_8
	- 1.0) + 5.0d-1*(y0_7_8 - 1.0)*(y0_7_8 - 1.0) + 5.0d-1*(z0_7_8 - 1.0)*(z0_7_8 -
	1.0) + 5.0d-1*(y11_7_8 - 1.0)*(y11_7_8 - 1.0) + 5.0d-1*(z11_7_8 - 1.0)*(z11_7_8
	- 1.0) + 5.0d-1*(y0_8_8 - 1.0)*(y0_8_8 - 1.0) + 5.0d-1*(z0_8_8 - 1.0)*(z0_8_8 -
	1.0) + 5.0d-1*(y11_8_8 - 1.0)*(y11_8_8 - 1.0) + 5.0d-1*(z11_8_8 - 1.0)*(z11_8_8
	- 1.0) + 5.0d-1*(y0_9_8 - 1.0)*(y0_9_8 - 1.0) + 5.0d-1*(z0_9_8 - 1.0)*(z0_9_8 -
	1.0) + 5.0d-1*(y11_9_8 - 1.0)*(y11_9_8 - 1.0) + 5.0d-1*(z11_9_8 - 1.0)*(z11_9_8
	- 1.0) + 5.0d-1*(y0_10_8 - 1.0)*(y0_10_8 - 1.0) + 5.0d-1*(z0_10_8 -
	1.0)*(z0_10_8 - 1.0) + 5.0d-1*(y11_10_8 - 1.0)*(y11_10_8 - 1.0) +
	5.0d-1*(z11_10_8 - 1.0)*(z11_10_8 - 1.0) + 5.0d-1*(y0_1_9 - 1.0)*(y0_1_9 - 1.0)
	+ 5.0d-1*(z0_1_9 - 1.0)*(z0_1_9 - 1.0) + 5.0d-1*(y11_1_9 - 1.0)*(y11_1_9 - 1.0)
	+ 5.0d-1*(z11_1_9 - 1.0)*(z11_1_9 - 1.0) + 5.0d-1*(y0_2_9 - 1.0)*(y0_2_9 - 1.0)
	+ 5.0d-1*(z0_2_9 - 1.0)*(z0_2_9 - 1.0) + 5.0d-1*(y11_2_9 - 1.0)*(y11_2_9 - 1.0)
	+ 5.0d-1*(z11_2_9 - 1.0)*(z11_2_9 - 1.0) + 5.0d-1*(y0_3_9 - 1.0)*(y0_3_9 - 1.0)
	+ 5.0d-1*(z0_3_9 - 1.0)*(z0_3_9 - 1.0) + 5.0d-1*(y11_3_9 - 1.0)*(y11_3_9 - 1.0)
	+ 5.0d-1*(z11_3_9 - 1.0)*(z11_3_9 - 1.0) + 5.0d-1*(y0_4_9 - 1.0)*(y0_4_9 - 1.0)
	+ 5.0d-1*(z0_4_9 - 1.0)*(z0_4_9 - 1.0) + 5.0d-1*(y11_4_9 - 1.0)*(y11_4_9 - 1.0)
	+ 5.0d-1*(z11_4_9 - 1.0)*(z11_4_9 - 1.0) + 5.0d-1*(y0_5_9 - 1.0)*(y0_5_9 - 1.0)
	+ 5.0d-1*(z0_5_9 - 1.0)*(z0_5_9 - 1.0) + 5.0d-1*(y11_5_9 - 1.0)*(y11_5_9 - 1.0)
	+ 5.0d-1*(z11_5_9 - 1.0)*(z11_5_9 - 1.0) + 5.0d-1*(y0_6_9 - 1.0)*(y0_6_9 - 1.0)
	+ 5.0d-1*(z0_6_9 - 1.0)*(z0_6_9 - 1.0) + 5.0d-1*(y11_6_9 - 1.0)*(y11_6_9 - 1.0)
	+ 5.0d-1*(z11_6_9 - 1.0)*(z11_6_9 - 1.0) + 5.0d-1*(y0_7_9 - 1.0)*(y0_7_9 - 1.0)
	+ 5.0d-1*(z0_7_9 - 1.0)*(z0_7_9 - 1.0) + 5.0d-1*(y11_7_9 - 1.0)*(y11_7_9 - 1.0)
	+ 5.0d-1*(z11_7_9 - 1.0)*(z11_7_9 - 1.0) + 5.0d-1*(y0_8_9 - 1.0)*(y0_8_9 - 1.0)
	+ 5.0d-1*(z0_8_9 - 1.0)*(z0_8_9 - 1.0) + 5.0d-1*(y11_8_9 - 1.0)*(y11_8_9 - 1.0)
	+ 5.0d-1*(z11_8_9 - 1.0)*(z11_8_9 - 1.0) + 5.0d-1*(y0_9_9 - 1.0)*(y0_9_9 - 1.0)
	+ 5.0d-1*(z0_9_9 - 1.0)*(z0_9_9 - 1.0) + 5.0d-1*(y11_9_9 - 1.0)*(y11_9_9 - 1.0)
	+ 5.0d-1*(z11_9_9 - 1.0)*(z11_9_9 - 1.0) + 5.0d-1*(y0_10_9 - 1.0)*(y0_10_9 -
	1.0) + 5.0d-1*(z0_10_9 - 1.0)*(z0_10_9 - 1.0) + 5.0d-1*(y11_10_9 -
	1.0)*(y11_10_9 - 1.0) + 5.0d-1*(z11_10_9 - 1.0)*(z11_10_9 - 1.0) +
	5.0d-1*(y0_1_10 - 1.0)*(y0_1_10 - 1.0) + 5.0d-1*(z0_1_10 - 1.0)*(z0_1_10 - 1.0)
	+ 5.0d-1*(y11_1_10 - 1.0)*(y11_1_10 - 1.0) + 5.0d-1*(z11_1_10 - 1.0)*(z11_1_10
	- 1.0) + 5.0d-1*(y0_2_10 - 1.0)*(y0_2_10 - 1.0) + 5.0d-1*(z0_2_10 -
	1.0)*(z0_2_10 - 1.0) + 5.0d-1*(y11_2_10 - 1.0)*(y11_2_10 - 1.0) +
	5.0d-1*(z11_2_10 - 1.0)*(z11_2_10 - 1.0) + 5.0d-1*(y0_3_10 - 1.0)*(y0_3_10 -
	1.0) + 5.0d-1*(z0_3_10 - 1.0)*(z0_3_10 - 1.0) + 5.0d-1*(y11_3_10 -
	1.0)*(y11_3_10 - 1.0) + 5.0d-1*(z11_3_10 - 1.0)*(z11_3_10 - 1.0) +
	5.0d-1*(y0_4_10 - 1.0)*(y0_4_10 - 1.0) + 5.0d-1*(z0_4_10 - 1.0)*(z0_4_10 - 1.0)
	+ 5.0d-1*(y11_4_10 - 1.0)*(y11_4_10 - 1.0) + 5.0d-1*(z11_4_10 - 1.0)*(z11_4_10
	- 1.0) + 5.0d-1*(y0_5_10 - 1.0)*(y0_5_10 - 1.0) + 5.0d-1*(z0_5_10 -
	1.0)*(z0_5_10 - 1.0) + 5.0d-1*(y11_5_10 - 1.0)*(y11_5_10 - 1.0) +
	5.0d-1*(z11_5_10 - 1.0)*(z11_5_10 - 1.0) + 5.0d-1*(y0_6_10 - 1.0)*(y0_6_10 -
	1.0) + 5.0d-1*(z0_6_10 - 1.0)*(z0_6_10 - 1.0) + 5.0d-1*(y11_6_10 -
	1.0)*(y11_6_10 - 1.0) + 5.0d-1*(z11_6_10 - 1.0)*(z11_6_10 - 1.0) +
	5.0d-1*(y0_7_10 - 1.0)*(y0_7_10 - 1.0) + 5.0d-1*(z0_7_10 - 1.0)*(z0_7_10 - 1.0)
	+ 5.0d-1*(y11_7_10 - 1.0)*(y11_7_10 - 1.0) + 5.0d-1*(z11_7_10 - 1.0)*(z11_7_10
	- 1.0) + 5.0d-1*(y0_8_10 - 1.0)*(y0_8_10 - 1.0) + 5.0d-1*(z0_8_10 -
	1.0)*(z0_8_10 - 1.0) + 5.0d-1*(y11_8_10 - 1.0)*(y11_8_10 - 1.0) +
	5.0d-1*(z11_8_10 - 1.0)*(z11_8_10 - 1.0) + 5.0d-1*(y0_9_10 - 1.0)*(y0_9_10 -
	1.0) + 5.0d-1*(z0_9_10 - 1.0)*(z0_9_10 - 1.0) + 5.0d-1*(y11_9_10 -
	1.0)*(y11_9_10 - 1.0) + 5.0d-1*(z11_9_10 - 1.0)*(z11_9_10 - 1.0) +
	5.0d-1*(y0_10_10 - 1.0)*(y0_10_10 - 1.0) + 5.0d-1*(z0_10_10 - 1.0)*(z0_10_10 -
	1.0) + 5.0d-1*(y11_10_10 - 1.0)*(y11_10_10 - 1.0) + 5.0d-1*(z11_10_10 -
	1.0)*(z11_10_10 - 1.0) + 5.0d-1*(x1_0_1 - 1.0)*(x1_0_1 - 1.0) + 5.0d-1*(z1_0_1
	- 1.0)*(z1_0_1 - 1.0) + 5.0d-1*(x1_11_1 - 1.0)*(x1_11_1 - 1.0) +
	5.0d-1*(z1_11_1 - 1.0)*(z1_11_1 - 1.0) + 5.0d-1*(x2_0_1 - 1.0)*(x2_0_1 - 1.0) +
	5.0d-1*(z2_0_1 - 1.0)*(z2_0_1 - 1.0) + 5.0d-1*(x2_11_1 - 1.0)*(x2_11_1 - 1.0) +
	5.0d-1*(z2_11_1 - 1.0)*(z2_11_1 - 1.0) + 5.0d-1*(x3_0_1 - 1.0)*(x3_0_1 - 1.0) +
	5.0d-1*(z3_0_1 - 1.0)*(z3_0_1 - 1.0) + 5.0d-1*(x3_11_1 - 1.0)*(x3_11_1 - 1.0) +
	5.0d-1*(z3_11_1 - 1.0)*(z3_11_1 - 1.0) + 5.0d-1*(x4_0_1 - 1.0)*(x4_0_1 - 1.0) +
	5.0d-1*(z4_0_1 - 1.0)*(z4_0_1 - 1.0) + 5.0d-1*(x4_11_1 - 1.0)*(x4_11_1 - 1.0) +
	5.0d-1*(z4_11_1 - 1.0)*(z4_11_1 - 1.0) + 5.0d-1*(x5_0_1 - 1.0)*(x5_0_1 - 1.0) +
	5.0d-1*(z5_0_1 - 1.0)*(z5_0_1 - 1.0) + 5.0d-1*(x5_11_1 - 1.0)*(x5_11_1 - 1.0) +
	5.0d-1*(z5_11_1 - 1.0)*(z5_11_1 - 1.0) + 5.0d-1*(x6_0_1 - 1.0)*(x6_0_1 - 1.0) +
	5.0d-1*(z6_0_1 - 1.0)*(z6_0_1 - 1.0) + 5.0d-1*(x6_11_1 - 1.0)*(x6_11_1 - 1.0) +
	5.0d-1*(z6_11_1 - 1.0)*(z6_11_1 - 1.0) + 5.0d-1*(x7_0_1 - 1.0)*(x7_0_1 - 1.0) +
	5.0d-1*(z7_0_1 - 1.0)*(z7_0_1 - 1.0) + 5.0d-1*(x7_11_1 - 1.0)*(x7_11_1 - 1.0) +
	5.0d-1*(z7_11_1 - 1.0)*(z7_11_1 - 1.0) + 5.0d-1*(x8_0_1 - 1.0)*(x8_0_1 - 1.0) +
	5.0d-1*(z8_0_1 - 1.0)*(z8_0_1 - 1.0) + 5.0d-1*(x8_11_1 - 1.0)*(x8_11_1 - 1.0) +
	5.0d-1*(z8_11_1 - 1.0)*(z8_11_1 - 1.0) + 5.0d-1*(x9_0_1 - 1.0)*(x9_0_1 - 1.0) +
	5.0d-1*(z9_0_1 - 1.0)*(z9_0_1 - 1.0) + 5.0d-1*(x9_11_1 - 1.0)*(x9_11_1 - 1.0) +
	5.0d-1*(z9_11_1 - 1.0)*(z9_11_1 - 1.0) + 5.0d-1*(x10_0_1 - 1.0)*(x10_0_1 - 1.0)
	+ 5.0d-1*(z10_0_1 - 1.0)*(z10_0_1 - 1.0) + 5.0d-1*(x10_11_1 - 1.0)*(x10_11_1 -
	1.0) + 5.0d-1*(z10_11_1 - 1.0)*(z10_11_1 - 1.0) + 5.0d-1*(x1_0_2 - 1.0)*(x1_0_2
	- 1.0) + 5.0d-1*(z1_0_2 - 1.0)*(z1_0_2 - 1.0) + 5.0d-1*(x1_11_2 - 1.0)*(x1_11_2
	- 1.0) + 5.0d-1*(z1_11_2 - 1.0)*(z1_11_2 - 1.0) + 5.0d-1*(x2_0_2 - 1.0)*(x2_0_2
	- 1.0) + 5.0d-1*(z2_0_2 - 1.0)*(z2_0_2 - 1.0) + 5.0d-1*(x2_11_2 - 1.0)*(x2_11_2
	- 1.0) + 5.0d-1*(z2_11_2 - 1.0)*(z2_11_2 - 1.0) + 5.0d-1*(x3_0_2 - 1.0)*(x3_0_2
	- 1.0) + 5.0d-1*(z3_0_2 - 1.0)*(z3_0_2 - 1.0) + 5.0d-1*(x3_11_2 - 1.0)*(x3_11_2
	- 1.0) + 5.0d-1*(z3_11_2 - 1.0)*(z3_11_2 - 1.0) + 5.0d-1*(x4_0_2 - 1.0)*(x4_0_2
	- 1.0) + 5.0d-1*(z4_0_2 - 1.0)*(z4_0_2 - 1.0) + 5.0d-1*(x4_11_2 - 1.0)*(x4_11_2
	- 1.0) + 5.0d-1*(z4_11_2 - 1.0)*(z4_11_2 - 1.0) + 5.0d-1*(x5_0_2 - 1.0)*(x5_0_2
	- 1.0) + 5.0d-1*(z5_0_2 - 1.0)*(z5_0_2 - 1.0) + 5.0d-1*(x5_11_2 - 1.0)*(x5_11_2
	- 1.0) + 5.0d-1*(z5_11_2 - 1.0)*(z5_11_2 - 1.0) + 5.0d-1*(x6_0_2 - 1.0)*(x6_0_2
	- 1.0) + 5.0d-1*(z6_0_2 - 1.0)*(z6_0_2 - 1.0) + 5.0d-1*(x6_11_2 - 1.0)*(x6_11_2
	- 1.0) + 5.0d-1*(z6_11_2 - 1.0)*(z6_11_2 - 1.0) + 5.0d-1*(x7_0_2 - 1.0)*(x7_0_2
	- 1.0) + 5.0d-1*(z7_0_2 - 1.0)*(z7_0_2 - 1.0) + 5.0d-1*(x7_11_2 - 1.0)*(x7_11_2
	- 1.0) + 5.0d-1*(z7_11_2 - 1.0)*(z7_11_2 - 1.0) + 5.0d-1*(x8_0_2 - 1.0)*(x8_0_2
	- 1.0) + 5.0d-1*(z8_0_2 - 1.0)*(z8_0_2 - 1.0) + 5.0d-1*(x8_11_2 - 1.0)*(x8_11_2
	- 1.0) + 5.0d-1*(z8_11_2 - 1.0)*(z8_11_2 - 1.0) + 5.0d-1*(x9_0_2 - 1.0)*(x9_0_2
	- 1.0) + 5.0d-1*(z9_0_2 - 1.0)*(z9_0_2 - 1.0) + 5.0d-1*(x9_11_2 - 1.0)*(x9_11_2
	- 1.0) + 5.0d-1*(z9_11_2 - 1.0)*(z9_11_2 - 1.0) + 5.0d-1*(x10_0_2 -
	1.0)*(x10_0_2 - 1.0) + 5.0d-1*(z10_0_2 - 1.0)*(z10_0_2 - 1.0) +
	5.0d-1*(x10_11_2 - 1.0)*(x10_11_2 - 1.0) + 5.0d-1*(z10_11_2 - 1.0)*(z10_11_2 -
	1.0) + 5.0d-1*(x1_0_3 - 1.0)*(x1_0_3 - 1.0) + 5.0d-1*(z1_0_3 - 1.0)*(z1_0_3 -
	1.0) + 5.0d-1*(x1_11_3 - 1.0)*(x1_11_3 - 1.0) + 5.0d-1*(z1_11_3 - 1.0)*(z1_11_3
	- 1.0) + 5.0d-1*(x2_0_3 - 1.0)*(x2_0_3 - 1.0) + 5.0d-1*(z2_0_3 - 1.0)*(z2_0_3 -
	1.0) + 5.0d-1*(x2_11_3 - 1.0)*(x2_11_3 - 1.0) + 5.0d-1*(z2_11_3 - 1.0)*(z2_11_3
	- 1.0) + 5.0d-1*(x3_0_3 - 1.0)*(x3_0_3 - 1.0) + 5.0d-1*(z3_0_3 - 1.0)*(z3_0_3 -
	1.0) + 5.0d-1*(x3_11_3 - 1.0)*(x3_11_3 - 1.0) + 5.0d-1*(z3_11_3 - 1.0)*(z3_11_3
	- 1.0) + 5.0d-1*(x4_0_3 - 1.0)*(x4_0_3 - 1.0) + 5.0d-1*(z4_0_3 - 1.0)*(z4_0_3 -
	1.0) + 5.0d-1*(x4_11_3 - 1.0)*(x4_11_3 - 1.0) + 5.0d-1*(z4_11_3 - 1.0)*(z4_11_3
	- 1.0) + 5.0d-1*(x5_0_3 - 1.0)*(x5_0_3 - 1.0) + 5.0d-1*(z5_0_3 - 1.0)*(z5_0_3 -
	1.0) + 5.0d-1*(x5_11_3 - 1.0)*(x5_11_3 - 1.0) + 5.0d-1*(z5_11_3 - 1.0)*(z5_11_3
	- 1.0) + 5.0d-1*(x6_0_3 - 1.0)*(x6_0_3 - 1.0) + 5.0d-1*(z6_0_3 - 1.0)*(z6_0_3 -
	1.0) + 5.0d-1*(x6_11_3 - 1.0)*(x6_11_3 - 1.0) + 5.0d-1*(z6_11_3 - 1.0)*(z6_11_3
	- 1.0) + 5.0d-1*(x7_0_3 - 1.0)*(x7_0_3 - 1.0) + 5.0d-1*(z7_0_3 - 1.0)*(z7_0_3 -
	1.0) + 5.0d-1*(x7_11_3 - 1.0)*(x7_11_3 - 1.0) + 5.0d-1*(z7_11_3 - 1.0)*(z7_11_3
	- 1.0) + 5.0d-1*(x8_0_3 - 1.0)*(x8_0_3 - 1.0) + 5.0d-1*(z8_0_3 - 1.0)*(z8_0_3 -
	1.0) + 5.0d-1*(x8_11_3 - 1.0)*(x8_11_3 - 1.0) + 5.0d-1*(z8_11_3 - 1.0)*(z8_11_3
	- 1.0) + 5.0d-1*(x9_0_3 - 1.0)*(x9_0_3 - 1.0) + 5.0d-1*(z9_0_3 - 1.0)*(z9_0_3 -
	1.0) + 5.0d-1*(x9_11_3 - 1.0)*(x9_11_3 - 1.0) + 5.0d-1*(z9_11_3 - 1.0)*(z9_11_3
	- 1.0) + 5.0d-1*(x10_0_3 - 1.0)*(x10_0_3 - 1.0) + 5.0d-1*(z10_0_3 -
	1.0)*(z10_0_3 - 1.0) + 5.0d-1*(x10_11_3 - 1.0)*(x10_11_3 - 1.0) +
	5.0d-1*(z10_11_3 - 1.0)*(z10_11_3 - 1.0) + 5.0d-1*(x1_0_4 - 1.0)*(x1_0_4 - 1.0)
	+ 5.0d-1*(z1_0_4 - 1.0)*(z1_0_4 - 1.0) + 5.0d-1*(x1_11_4 - 1.0)*(x1_11_4 - 1.0)
	+ 5.0d-1*(z1_11_4 - 1.0)*(z1_11_4 - 1.0) + 5.0d-1*(x2_0_4 - 1.0)*(x2_0_4 - 1.0)
	+ 5.0d-1*(z2_0_4 - 1.0)*(z2_0_4 - 1.0) + 5.0d-1*(x2_11_4 - 1.0)*(x2_11_4 - 1.0)
	+ 5.0d-1*(z2_11_4 - 1.0)*(z2_11_4 - 1.0) + 5.0d-1*(x3_0_4 - 1.0)*(x3_0_4 - 1.0)
	+ 5.0d-1*(z3_0_4 - 1.0)*(z3_0_4 - 1.0) + 5.0d-1*(x3_11_4 - 1.0)*(x3_11_4 - 1.0)
	+ 5.0d-1*(z3_11_4 - 1.0)*(z3_11_4 - 1.0) + 5.0d-1*(x4_0_4 - 1.0)*(x4_0_4 - 1.0)
	+ 5.0d-1*(z4_0_4 - 1.0)*(z4_0_4 - 1.0) + 5.0d-1*(x4_11_4 - 1.0)*(x4_11_4 - 1.0)
	+ 5.0d-1*(z4_11_4 - 1.0)*(z4_11_4 - 1.0) + 5.0d-1*(x5_0_4 - 1.0)*(x5_0_4 - 1.0)
	+ 5.0d-1*(z5_0_4 - 1.0)*(z5_0_4 - 1.0) + 5.0d-1*(x5_11_4 - 1.0)*(x5_11_4 - 1.0)
	+ 5.0d-1*(z5_11_4 - 1.0)*(z5_11_4 - 1.0) + 5.0d-1*(x6_0_4 - 1.0)*(x6_0_4 - 1.0)
	+ 5.0d-1*(z6_0_4 - 1.0)*(z6_0_4 - 1.0) + 5.0d-1*(x6_11_4 - 1.0)*(x6_11_4 - 1.0)
	+ 5.0d-1*(z6_11_4 - 1.0)*(z6_11_4 - 1.0) + 5.0d-1*(x7_0_4 - 1.0)*(x7_0_4 - 1.0)
	+ 5.0d-1*(z7_0_4 - 1.0)*(z7_0_4 - 1.0) + 5.0d-1*(x7_11_4 - 1.0)*(x7_11_4 - 1.0)
	+ 5.0d-1*(z7_11_4 - 1.0)*(z7_11_4 - 1.0) + 5.0d-1*(x8_0_4 - 1.0)*(x8_0_4 - 1.0)
	+ 5.0d-1*(z8_0_4 - 1.0)*(z8_0_4 - 1.0) + 5.0d-1*(x8_11_4 - 1.0)*(x8_11_4 - 1.0)
	+ 5.0d-1*(z8_11_4 - 1.0)*(z8_11_4 - 1.0) + 5.0d-1*(x9_0_4 - 1.0)*(x9_0_4 - 1.0)
	+ 5.0d-1*(z9_0_4 - 1.0)*(z9_0_4 - 1.0) + 5.0d-1*(x9_11_4 - 1.0)*(x9_11_4 - 1.0)
	+ 5.0d-1*(z9_11_4 - 1.0)*(z9_11_4 - 1.0) + 5.0d-1*(x10_0_4 - 1.0)*(x10_0_4 -
	1.0) + 5.0d-1*(z10_0_4 - 1.0)*(z10_0_4 - 1.0) + 5.0d-1*(x10_11_4 -
	1.0)*(x10_11_4 - 1.0) + 5.0d-1*(z10_11_4 - 1.0)*(z10_11_4 - 1.0) +
	5.0d-1*(x1_0_5 - 1.0)*(x1_0_5 - 1.0) + 5.0d-1*(z1_0_5 - 1.0)*(z1_0_5 - 1.0) +
	5.0d-1*(x1_11_5 - 1.0)*(x1_11_5 - 1.0) + 5.0d-1*(z1_11_5 - 1.0)*(z1_11_5 - 1.0)
	+ 5.0d-1*(x2_0_5 - 1.0)*(x2_0_5 - 1.0) + 5.0d-1*(z2_0_5 - 1.0)*(z2_0_5 - 1.0) +
	5.0d-1*(x2_11_5 - 1.0)*(x2_11_5 - 1.0) + 5.0d-1*(z2_11_5 - 1.0)*(z2_11_5 - 1.0)
	+ 5.0d-1*(x3_0_5 - 1.0)*(x3_0_5 - 1.0) + 5.0d-1*(z3_0_5 - 1.0)*(z3_0_5 - 1.0) +
	5.0d-1*(x3_11_5 - 1.0)*(x3_11_5 - 1.0) + 5.0d-1*(z3_11_5 - 1.0)*(z3_11_5 - 1.0)
	+ 5.0d-1*(x4_0_5 - 1.0)*(x4_0_5 - 1.0) + 5.0d-1*(z4_0_5 - 1.0)*(z4_0_5 - 1.0) +
	5.0d-1*(x4_11_5 - 1.0)*(x4_11_5 - 1.0) + 5.0d-1*(z4_11_5 - 1.0)*(z4_11_5 - 1.0)
	+ 5.0d-1*(x5_0_5 - 1.0)*(x5_0_5 - 1.0) + 5.0d-1*(z5_0_5 - 1.0)*(z5_0_5 - 1.0) +
	5.0d-1*(x5_11_5 - 1.0)*(x5_11_5 - 1.0) + 5.0d-1*(z5_11_5 - 1.0)*(z5_11_5 - 1.0)
	+ 5.0d-1*(x6_0_5 - 1.0)*(x6_0_5 - 1.0) + 5.0d-1*(z6_0_5 - 1.0)*(z6_0_5 - 1.0) +
	5.0d-1*(x6_11_5 - 1.0)*(x6_11_5 - 1.0) + 5.0d-1*(z6_11_5 - 1.0)*(z6_11_5 - 1.0)
	+ 5.0d-1*(x7_0_5 - 1.0)*(x7_0_5 - 1.0) + 5.0d-1*(z7_0_5 - 1.0)*(z7_0_5 - 1.0) +
	5.0d-1*(x7_11_5 - 1.0)*(x7_11_5 - 1.0) + 5.0d-1*(z7_11_5 - 1.0)*(z7_11_5 - 1.0)
	+ 5.0d-1*(x8_0_5 - 1.0)*(x8_0_5 - 1.0) + 5.0d-1*(z8_0_5 - 1.0)*(z8_0_5 - 1.0) +
	5.0d-1*(x8_11_5 - 1.0)*(x8_11_5 - 1.0) + 5.0d-1*(z8_11_5 - 1.0)*(z8_11_5 - 1.0)
	+ 5.0d-1*(x9_0_5 - 1.0)*(x9_0_5 - 1.0) + 5.0d-1*(z9_0_5 - 1.0)*(z9_0_5 - 1.0) +
	5.0d-1*(x9_11_5 - 1.0)*(x9_11_5 - 1.0) + 5.0d-1*(z9_11_5 - 1.0)*(z9_11_5 - 1.0)
	+ 5.0d-1*(x10_0_5 - 1.0)*(x10_0_5 - 1.0) + 5.0d-1*(z10_0_5 - 1.0)*(z10_0_5 -
	1.0) + 5.0d-1*(x10_11_5 - 1.0)*(x10_11_5 - 1.0) + 5.0d-1*(z10_11_5 -
	1.0)*(z10_11_5 - 1.0) + 5.0d-1*(x1_0_6 - 1.0)*(x1_0_6 - 1.0) + 5.0d-1*(z1_0_6 -
	1.0)*(z1_0_6 - 1.0) + 5.0d-1*(x1_11_6 - 1.0)*(x1_11_6 - 1.0) + 5.0d-1*(z1_11_6
	- 1.0)*(z1_11_6 - 1.0) + 5.0d-1*(x2_0_6 - 1.0)*(x2_0_6 - 1.0) + 5.0d-1*(z2_0_6
	- 1.0)*(z2_0_6 - 1.0) + 5.0d-1*(x2_11_6 - 1.0)*(x2_11_6 - 1.0) +
	5.0d-1*(z2_11_6 - 1.0)*(z2_11_6 - 1.0) + 5.0d-1*(x3_0_6 - 1.0)*(x3_0_6 - 1.0) +
	5.0d-1*(z3_0_6 - 1.0)*(z3_0_6 - 1.0) + 5.0d-1*(x3_11_6 - 1.0)*(x3_11_6 - 1.0) +
	5.0d-1*(z3_11_6 - 1.0)*(z3_11_6 - 1.0) + 5.0d-1*(x4_0_6 - 1.0)*(x4_0_6 - 1.0) +
	5.0d-1*(z4_0_6 - 1.0)*(z4_0_6 - 1.0) + 5.0d-1*(x4_11_6 - 1.0)*(x4_11_6 - 1.0) +
	5.0d-1*(z4_11_6 - 1.0)*(z4_11_6 - 1.0) + 5.0d-1*(x5_0_6 - 1.0)*(x5_0_6 - 1.0) +
	5.0d-1*(z5_0_6 - 1.0)*(z5_0_6 - 1.0) + 5.0d-1*(x5_11_6 - 1.0)*(x5_11_6 - 1.0) +
	5.0d-1*(z5_11_6 - 1.0)*(z5_11_6 - 1.0) + 5.0d-1*(x6_0_6 - 1.0)*(x6_0_6 - 1.0) +
	5.0d-1*(z6_0_6 - 1.0)*(z6_0_6 - 1.0) + 5.0d-1*(x6_11_6 - 1.0)*(x6_11_6 - 1.0) +
	5.0d-1*(z6_11_6 - 1.0)*(z6_11_6 - 1.0) + 5.0d-1*(x7_0_6 - 1.0)*(x7_0_6 - 1.0) +
	5.0d-1*(z7_0_6 - 1.0)*(z7_0_6 - 1.0) + 5.0d-1*(x7_11_6 - 1.0)*(x7_11_6 - 1.0) +
	5.0d-1*(z7_11_6 - 1.0)*(z7_11_6 - 1.0) + 5.0d-1*(x8_0_6 - 1.0)*(x8_0_6 - 1.0) +
	5.0d-1*(z8_0_6 - 1.0)*(z8_0_6 - 1.0) + 5.0d-1*(x8_11_6 - 1.0)*(x8_11_6 - 1.0) +
	5.0d-1*(z8_11_6 - 1.0)*(z8_11_6 - 1.0) + 5.0d-1*(x9_0_6 - 1.0)*(x9_0_6 - 1.0) +
	5.0d-1*(z9_0_6 - 1.0)*(z9_0_6 - 1.0) + 5.0d-1*(x9_11_6 - 1.0)*(x9_11_6 - 1.0) +
	5.0d-1*(z9_11_6 - 1.0)*(z9_11_6 - 1.0) + 5.0d-1*(x10_0_6 - 1.0)*(x10_0_6 - 1.0)
	+ 5.0d-1*(z10_0_6 - 1.0)*(z10_0_6 - 1.0) + 5.0d-1*(x10_11_6 - 1.0)*(x10_11_6 -
	1.0) + 5.0d-1*(z10_11_6 - 1.0)*(z10_11_6 - 1.0) + 5.0d-1*(x1_0_7 - 1.0)*(x1_0_7
	- 1.0) + 5.0d-1*(z1_0_7 - 1.0)*(z1_0_7 - 1.0) + 5.0d-1*(x1_11_7 - 1.0)*(x1_11_7
	- 1.0) + 5.0d-1*(z1_11_7 - 1.0)*(z1_11_7 - 1.0) + 5.0d-1*(x2_0_7 - 1.0)*(x2_0_7
	- 1.0) + 5.0d-1*(z2_0_7 - 1.0)*(z2_0_7 - 1.0) + 5.0d-1*(x2_11_7 - 1.0)*(x2_11_7
	- 1.0) + 5.0d-1*(z2_11_7 - 1.0)*(z2_11_7 - 1.0) + 5.0d-1*(x3_0_7 - 1.0)*(x3_0_7
	- 1.0) + 5.0d-1*(z3_0_7 - 1.0)*(z3_0_7 - 1.0) + 5.0d-1*(x3_11_7 - 1.0)*(x3_11_7
	- 1.0) + 5.0d-1*(z3_11_7 - 1.0)*(z3_11_7 - 1.0) + 5.0d-1*(x4_0_7 - 1.0)*(x4_0_7
	- 1.0) + 5.0d-1*(z4_0_7 - 1.0)*(z4_0_7 - 1.0) + 5.0d-1*(x4_11_7 - 1.0)*(x4_11_7
	- 1.0) + 5.0d-1*(z4_11_7 - 1.0)*(z4_11_7 - 1.0) + 5.0d-1*(x5_0_7 - 1.0)*(x5_0_7
	- 1.0) + 5.0d-1*(z5_0_7 - 1.0)*(z5_0_7 - 1.0) + 5.0d-1*(x5_11_7 - 1.0)*(x5_11_7
	- 1.0) + 5.0d-1*(z5_11_7 - 1.0)*(z5_11_7 - 1.0) + 5.0d-1*(x6_0_7 - 1.0)*(x6_0_7
	- 1.0) + 5.0d-1*(z6_0_7 - 1.0)*(z6_0_7 - 1.0) + 5.0d-1*(x6_11_7 - 1.0)*(x6_11_7
	- 1.0) + 5.0d-1*(z6_11_7 - 1.0)*(z6_11_7 - 1.0) + 5.0d-1*(x7_0_7 - 1.0)*(x7_0_7
	- 1.0) + 5.0d-1*(z7_0_7 - 1.0)*(z7_0_7 - 1.0) + 5.0d-1*(x7_11_7 - 1.0)*(x7_11_7
	- 1.0) + 5.0d-1*(z7_11_7 - 1.0)*(z7_11_7 - 1.0) + 5.0d-1*(x8_0_7 - 1.0)*(x8_0_7
	- 1.0) + 5.0d-1*(z8_0_7 - 1.0)*(z8_0_7 - 1.0) + 5.0d-1*(x8_11_7 - 1.0)*(x8_11_7
	- 1.0) + 5.0d-1*(z8_11_7 - 1.0)*(z8_11_7 - 1.0) + 5.0d-1*(x9_0_7 - 1.0)*(x9_0_7
	- 1.0) + 5.0d-1*(z9_0_7 - 1.0)*(z9_0_7 - 1.0) + 5.0d-1*(x9_11_7 - 1.0)*(x9_11_7
	- 1.0) + 5.0d-1*(z9_11_7 - 1.0)*(z9_11_7 - 1.0) + 5.0d-1*(x10_0_7 -
	1.0)*(x10_0_7 - 1.0) + 5.0d-1*(z10_0_7 - 1.0)*(z10_0_7 - 1.0) +
	5.0d-1*(x10_11_7 - 1.0)*(x10_11_7 - 1.0) + 5.0d-1*(z10_11_7 - 1.0)*(z10_11_7 -
	1.0) + 5.0d-1*(x1_0_8 - 1.0)*(x1_0_8 - 1.0) + 5.0d-1*(z1_0_8 - 1.0)*(z1_0_8 -
	1.0) + 5.0d-1*(x1_11_8 - 1.0)*(x1_11_8 - 1.0) + 5.0d-1*(z1_11_8 - 1.0)*(z1_11_8
	- 1.0) + 5.0d-1*(x2_0_8 - 1.0)*(x2_0_8 - 1.0) + 5.0d-1*(z2_0_8 - 1.0)*(z2_0_8 -
	1.0) + 5.0d-1*(x2_11_8 - 1.0)*(x2_11_8 - 1.0) + 5.0d-1*(z2_11_8 - 1.0)*(z2_11_8
	- 1.0) + 5.0d-1*(x3_0_8 - 1.0)*(x3_0_8 - 1.0) + 5.0d-1*(z3_0_8 - 1.0)*(z3_0_8 -
	1.0) + 5.0d-1*(x3_11_8 - 1.0)*(x3_11_8 - 1.0) + 5.0d-1*(z3_11_8 - 1.0)*(z3_11_8
	- 1.0) + 5.0d-1*(x4_0_8 - 1.0)*(x4_0_8 - 1.0) + 5.0d-1*(z4_0_8 - 1.0)*(z4_0_8 -
	1.0) + 5.0d-1*(x4_11_8 - 1.0)*(x4_11_8 - 1.0) + 5.0d-1*(z4_11_8 - 1.0)*(z4_11_8
	- 1.0) + 5.0d-1*(x5_0_8 - 1.0)*(x5_0_8 - 1.0) + 5.0d-1*(z5_0_8 - 1.0)*(z5_0_8 -
	1.0) + 5.0d-1*(x5_11_8 - 1.0)*(x5_11_8 - 1.0) + 5.0d-1*(z5_11_8 - 1.0)*(z5_11_8
	- 1.0) + 5.0d-1*(x6_0_8 - 1.0)*(x6_0_8 - 1.0) + 5.0d-1*(z6_0_8 - 1.0)*(z6_0_8 -
	1.0) + 5.0d-1*(x6_11_8 - 1.0)*(x6_11_8 - 1.0) + 5.0d-1*(z6_11_8 - 1.0)*(z6_11_8
	- 1.0) + 5.0d-1*(x7_0_8 - 1.0)*(x7_0_8 - 1.0) + 5.0d-1*(z7_0_8 - 1.0)*(z7_0_8 -
	1.0) + 5.0d-1*(x7_11_8 - 1.0)*(x7_11_8 - 1.0) + 5.0d-1*(z7_11_8 - 1.0)*(z7_11_8
	- 1.0) + 5.0d-1*(x8_0_8 - 1.0)*(x8_0_8 - 1.0) + 5.0d-1*(z8_0_8 - 1.0)*(z8_0_8 -
	1.0) + 5.0d-1*(x8_11_8 - 1.0)*(x8_11_8 - 1.0) + 5.0d-1*(z8_11_8 - 1.0)*(z8_11_8
	- 1.0) + 5.0d-1*(x9_0_8 - 1.0)*(x9_0_8 - 1.0) + 5.0d-1*(z9_0_8 - 1.0)*(z9_0_8 -
	1.0) + 5.0d-1*(x9_11_8 - 1.0)*(x9_11_8 - 1.0) + 5.0d-1*(z9_11_8 - 1.0)*(z9_11_8
	- 1.0) + 5.0d-1*(x10_0_8 - 1.0)*(x10_0_8 - 1.0) + 5.0d-1*(z10_0_8 -
	1.0)*(z10_0_8 - 1.0) + 5.0d-1*(x10_11_8 - 1.0)*(x10_11_8 - 1.0) +
	5.0d-1*(z10_11_8 - 1.0)*(z10_11_8 - 1.0) + 5.0d-1*(x1_0_9 - 1.0)*(x1_0_9 - 1.0)
	+ 5.0d-1*(z1_0_9 - 1.0)*(z1_0_9 - 1.0) + 5.0d-1*(x1_11_9 - 1.0)*(x1_11_9 - 1.0)
	+ 5.0d-1*(z1_11_9 - 1.0)*(z1_11_9 - 1.0) + 5.0d-1*(x2_0_9 - 1.0)*(x2_0_9 - 1.0)
	+ 5.0d-1*(z2_0_9 - 1.0)*(z2_0_9 - 1.0) + 5.0d-1*(x2_11_9 - 1.0)*(x2_11_9 - 1.0)
	+ 5.0d-1*(z2_11_9 - 1.0)*(z2_11_9 - 1.0) + 5.0d-1*(x3_0_9 - 1.0)*(x3_0_9 - 1.0)
	+ 5.0d-1*(z3_0_9 - 1.0)*(z3_0_9 - 1.0) + 5.0d-1*(x3_11_9 - 1.0)*(x3_11_9 - 1.0)
	+ 5.0d-1*(z3_11_9 - 1.0)*(z3_11_9 - 1.0) + 5.0d-1*(x4_0_9 - 1.0)*(x4_0_9 - 1.0)
	+ 5.0d-1*(z4_0_9 - 1.0)*(z4_0_9 - 1.0) + 5.0d-1*(x4_11_9 - 1.0)*(x4_11_9 - 1.0)
	+ 5.0d-1*(z4_11_9 - 1.0)*(z4_11_9 - 1.0) + 5.0d-1*(x5_0_9 - 1.0)*(x5_0_9 - 1.0)
	+ 5.0d-1*(z5_0_9 - 1.0)*(z5_0_9 - 1.0) + 5.0d-1*(x5_11_9 - 1.0)*(x5_11_9 - 1.0)
	+ 5.0d-1*(z5_11_9 - 1.0)*(z5_11_9 - 1.0) + 5.0d-1*(x6_0_9 - 1.0)*(x6_0_9 - 1.0)
	+ 5.0d-1*(z6_0_9 - 1.0)*(z6_0_9 - 1.0) + 5.0d-1*(x6_11_9 - 1.0)*(x6_11_9 - 1.0)
	+ 5.0d-1*(z6_11_9 - 1.0)*(z6_11_9 - 1.0) + 5.0d-1*(x7_0_9 - 1.0)*(x7_0_9 - 1.0)
	+ 5.0d-1*(z7_0_9 - 1.0)*(z7_0_9 - 1.0) + 5.0d-1*(x7_11_9 - 1.0)*(x7_11_9 - 1.0)
	+ 5.0d-1*(z7_11_9 - 1.0)*(z7_11_9 - 1.0) + 5.0d-1*(x8_0_9 - 1.0)*(x8_0_9 - 1.0)
	+ 5.0d-1*(z8_0_9 - 1.0)*(z8_0_9 - 1.0) + 5.0d-1*(x8_11_9 - 1.0)*(x8_11_9 - 1.0)
	+ 5.0d-1*(z8_11_9 - 1.0)*(z8_11_9 - 1.0) + 5.0d-1*(x9_0_9 - 1.0)*(x9_0_9 - 1.0)
	+ 5.0d-1*(z9_0_9 - 1.0)*(z9_0_9 - 1.0) + 5.0d-1*(x9_11_9 - 1.0)*(x9_11_9 - 1.0)
	+ 5.0d-1*(z9_11_9 - 1.0)*(z9_11_9 - 1.0) + 5.0d-1*(x10_0_9 - 1.0)*(x10_0_9 -
	1.0) + 5.0d-1*(z10_0_9 - 1.0)*(z10_0_9 - 1.0) + 5.0d-1*(x10_11_9 -
	1.0)*(x10_11_9 - 1.0) + 5.0d-1*(z10_11_9 - 1.0)*(z10_11_9 - 1.0) +
	5.0d-1*(x1_0_10 - 1.0)*(x1_0_10 - 1.0) + 5.0d-1*(z1_0_10 - 1.0)*(z1_0_10 - 1.0)
	+ 5.0d-1*(x1_11_10 - 1.0)*(x1_11_10 - 1.0) + 5.0d-1*(z1_11_10 - 1.0)*(z1_11_10
	- 1.0) + 5.0d-1*(x2_0_10 - 1.0)*(x2_0_10 - 1.0) + 5.0d-1*(z2_0_10 -
	1.0)*(z2_0_10 - 1.0) + 5.0d-1*(x2_11_10 - 1.0)*(x2_11_10 - 1.0) +
	5.0d-1*(z2_11_10 - 1.0)*(z2_11_10 - 1.0) + 5.0d-1*(x3_0_10 - 1.0)*(x3_0_10 -
	1.0) + 5.0d-1*(z3_0_10 - 1.0)*(z3_0_10 - 1.0) + 5.0d-1*(x3_11_10 -
	1.0)*(x3_11_10 - 1.0) + 5.0d-1*(z3_11_10 - 1.0)*(z3_11_10 - 1.0) +
	5.0d-1*(x4_0_10 - 1.0)*(x4_0_10 - 1.0) + 5.0d-1*(z4_0_10 - 1.0)*(z4_0_10 - 1.0)
	+ 5.0d-1*(x4_11_10 - 1.0)*(x4_11_10 - 1.0) + 5.0d-1*(z4_11_10 - 1.0)*(z4_11_10
	- 1.0) + 5.0d-1*(x5_0_10 - 1.0)*(x5_0_10 - 1.0) + 5.0d-1*(z5_0_10 -
	1.0)*(z5_0_10 - 1.0) + 5.0d-1*(x5_11_10 - 1.0)*(x5_11_10 - 1.0) +
	5.0d-1*(z5_11_10 - 1.0)*(z5_11_10 - 1.0) + 5.0d-1*(x6_0_10 - 1.0)*(x6_0_10 -
	1.0) + 5.0d-1*(z6_0_10 - 1.0)*(z6_0_10 - 1.0) + 5.0d-1*(x6_11_10 -
	1.0)*(x6_11_10 - 1.0) + 5.0d-1*(z6_11_10 - 1.0)*(z6_11_10 - 1.0) +
	5.0d-1*(x7_0_10 - 1.0)*(x7_0_10 - 1.0) + 5.0d-1*(z7_0_10 - 1.0)*(z7_0_10 - 1.0)
	+ 5.0d-1*(x7_11_10 - 1.0)*(x7_11_10 - 1.0) + 5.0d-1*(z7_11_10 - 1.0)*(z7_11_10
	- 1.0) + 5.0d-1*(x8_0_10 - 1.0)*(x8_0_10 - 1.0) + 5.0d-1*(z8_0_10 -
	1.0)*(z8_0_10 - 1.0) + 5.0d-1*(x8_11_10 - 1.0)*(x8_11_10 - 1.0) +
	5.0d-1*(z8_11_10 - 1.0)*(z8_11_10 - 1.0) + 5.0d-1*(x9_0_10 - 1.0)*(x9_0_10 -
	1.0) + 5.0d-1*(z9_0_10 - 1.0)*(z9_0_10 - 1.0) + 5.0d-1*(x9_11_10 -
	1.0)*(x9_11_10 - 1.0) + 5.0d-1*(z9_11_10 - 1.0)*(z9_11_10 - 1.0) +
	5.0d-1*(x10_0_10 - 1.0)*(x10_0_10 - 1.0) + 5.0d-1*(z10_0_10 - 1.0)*(z10_0_10 -
	1.0) + 5.0d-1*(x10_11_10 - 1.0)*(x10_11_10 - 1.0) + 5.0d-1*(z10_11_10 -
	1.0)*(z10_11_10 - 1.0) + 5.0d-1*(x1_1_0 - 1.0)*(x1_1_0 - 1.0) + 5.0d-1*(y1_1_0
	- 1.0)*(y1_1_0 - 1.0) + 5.0d-1*(x1_1_11 - 1.0)*(x1_1_11 - 1.0) +
	5.0d-1*(y1_1_11 - 1.0)*(y1_1_11 - 1.0) + 5.0d-1*(x2_1_0 - 1.0)*(x2_1_0 - 1.0) +
	5.0d-1*(y2_1_0 - 1.0)*(y2_1_0 - 1.0) + 5.0d-1*(x2_1_11 - 1.0)*(x2_1_11 - 1.0) +
	5.0d-1*(y2_1_11 - 1.0)*(y2_1_11 - 1.0) + 5.0d-1*(x3_1_0 - 1.0)*(x3_1_0 - 1.0) +
	5.0d-1*(y3_1_0 - 1.0)*(y3_1_0 - 1.0) + 5.0d-1*(x3_1_11 - 1.0)*(x3_1_11 - 1.0) +
	5.0d-1*(y3_1_11 - 1.0)*(y3_1_11 - 1.0) + 5.0d-1*(x4_1_0 - 1.0)*(x4_1_0 - 1.0) +
	5.0d-1*(y4_1_0 - 1.0)*(y4_1_0 - 1.0) + 5.0d-1*(x4_1_11 - 1.0)*(x4_1_11 - 1.0) +
	5.0d-1*(y4_1_11 - 1.0)*(y4_1_11 - 1.0) + 5.0d-1*(x5_1_0 - 1.0)*(x5_1_0 - 1.0) +
	5.0d-1*(y5_1_0 - 1.0)*(y5_1_0 - 1.0) + 5.0d-1*(x5_1_11 - 1.0)*(x5_1_11 - 1.0) +
	5.0d-1*(y5_1_11 - 1.0)*(y5_1_11 - 1.0) + 5.0d-1*(x6_1_0 - 1.0)*(x6_1_0 - 1.0) +
	5.0d-1*(y6_1_0 - 1.0)*(y6_1_0 - 1.0) + 5.0d-1*(x6_1_11 - 1.0)*(x6_1_11 - 1.0) +
	5.0d-1*(y6_1_11 - 1.0)*(y6_1_11 - 1.0) + 5.0d-1*(x7_1_0 - 1.0)*(x7_1_0 - 1.0) +
	5.0d-1*(y7_1_0 - 1.0)*(y7_1_0 - 1.0) + 5.0d-1*(x7_1_11 - 1.0)*(x7_1_11 - 1.0) +
	5.0d-1*(y7_1_11 - 1.0)*(y7_1_11 - 1.0) + 5.0d-1*(x8_1_0 - 1.0)*(x8_1_0 - 1.0) +
	5.0d-1*(y8_1_0 - 1.0)*(y8_1_0 - 1.0) + 5.0d-1*(x8_1_11 - 1.0)*(x8_1_11 - 1.0) +
	5.0d-1*(y8_1_11 - 1.0)*(y8_1_11 - 1.0) + 5.0d-1*(x9_1_0 - 1.0)*(x9_1_0 - 1.0) +
	5.0d-1*(y9_1_0 - 1.0)*(y9_1_0 - 1.0) + 5.0d-1*(x9_1_11 - 1.0)*(x9_1_11 - 1.0) +
	5.0d-1*(y9_1_11 - 1.0)*(y9_1_11 - 1.0) + 5.0d-1*(x10_1_0 - 1.0)*(x10_1_0 - 1.0)
	+ 5.0d-1*(y10_1_0 - 1.0)*(y10_1_0 - 1.0) + 5.0d-1*(x10_1_11 - 1.0)*(x10_1_11 -
	1.0) + 5.0d-1*(y10_1_11 - 1.0)*(y10_1_11 - 1.0) + 5.0d-1*(x1_2_0 - 1.0)*(x1_2_0
	- 1.0) + 5.0d-1*(y1_2_0 - 1.0)*(y1_2_0 - 1.0) + 5.0d-1*(x1_2_11 - 1.0)*(x1_2_11
	- 1.0) + 5.0d-1*(y1_2_11 - 1.0)*(y1_2_11 - 1.0) + 5.0d-1*(x2_2_0 - 1.0)*(x2_2_0
	- 1.0) + 5.0d-1*(y2_2_0 - 1.0)*(y2_2_0 - 1.0) + 5.0d-1*(x2_2_11 - 1.0)*(x2_2_11
	- 1.0) + 5.0d-1*(y2_2_11 - 1.0)*(y2_2_11 - 1.0) + 5.0d-1*(x3_2_0 - 1.0)*(x3_2_0
	- 1.0) + 5.0d-1*(y3_2_0 - 1.0)*(y3_2_0 - 1.0) + 5.0d-1*(x3_2_11 - 1.0)*(x3_2_11
	- 1.0) + 5.0d-1*(y3_2_11 - 1.0)*(y3_2_11 - 1.0) + 5.0d-1*(x4_2_0 - 1.0)*(x4_2_0
	- 1.0) + 5.0d-1*(y4_2_0 - 1.0)*(y4_2_0 - 1.0) + 5.0d-1*(x4_2_11 - 1.0)*(x4_2_11
	- 1.0) + 5.0d-1*(y4_2_11 - 1.0)*(y4_2_11 - 1.0) + 5.0d-1*(x5_2_0 - 1.0)*(x5_2_0
	- 1.0) + 5.0d-1*(y5_2_0 - 1.0)*(y5_2_0 - 1.0) + 5.0d-1*(x5_2_11 - 1.0)*(x5_2_11
	- 1.0) + 5.0d-1*(y5_2_11 - 1.0)*(y5_2_11 - 1.0) + 5.0d-1*(x6_2_0 - 1.0)*(x6_2_0
	- 1.0) + 5.0d-1*(y6_2_0 - 1.0)*(y6_2_0 - 1.0) + 5.0d-1*(x6_2_11 - 1.0)*(x6_2_11
	- 1.0) + 5.0d-1*(y6_2_11 - 1.0)*(y6_2_11 - 1.0) + 5.0d-1*(x7_2_0 - 1.0)*(x7_2_0
	- 1.0) + 5.0d-1*(y7_2_0 - 1.0)*(y7_2_0 - 1.0) + 5.0d-1*(x7_2_11 - 1.0)*(x7_2_11
	- 1.0) + 5.0d-1*(y7_2_11 - 1.0)*(y7_2_11 - 1.0) + 5.0d-1*(x8_2_0 - 1.0)*(x8_2_0
	- 1.0) + 5.0d-1*(y8_2_0 - 1.0)*(y8_2_0 - 1.0) + 5.0d-1*(x8_2_11 - 1.0)*(x8_2_11
	- 1.0) + 5.0d-1*(y8_2_11 - 1.0)*(y8_2_11 - 1.0) + 5.0d-1*(x9_2_0 - 1.0)*(x9_2_0
	- 1.0) + 5.0d-1*(y9_2_0 - 1.0)*(y9_2_0 - 1.0) + 5.0d-1*(x9_2_11 - 1.0)*(x9_2_11
	- 1.0) + 5.0d-1*(y9_2_11 - 1.0)*(y9_2_11 - 1.0) + 5.0d-1*(x10_2_0 -
	1.0)*(x10_2_0 - 1.0) + 5.0d-1*(y10_2_0 - 1.0)*(y10_2_0 - 1.0) +
	5.0d-1*(x10_2_11 - 1.0)*(x10_2_11 - 1.0) + 5.0d-1*(y10_2_11 - 1.0)*(y10_2_11 -
	1.0) + 5.0d-1*(x1_3_0 - 1.0)*(x1_3_0 - 1.0) + 5.0d-1*(y1_3_0 - 1.0)*(y1_3_0 -
	1.0) + 5.0d-1*(x1_3_11 - 1.0)*(x1_3_11 - 1.0) + 5.0d-1*(y1_3_11 - 1.0)*(y1_3_11
	- 1.0) + 5.0d-1*(x2_3_0 - 1.0)*(x2_3_0 - 1.0) + 5.0d-1*(y2_3_0 - 1.0)*(y2_3_0 -
	1.0) + 5.0d-1*(x2_3_11 - 1.0)*(x2_3_11 - 1.0) + 5.0d-1*(y2_3_11 - 1.0)*(y2_3_11
	- 1.0) + 5.0d-1*(x3_3_0 - 1.0)*(x3_3_0 - 1.0) + 5.0d-1*(y3_3_0 - 1.0)*(y3_3_0 -
	1.0) + 5.0d-1*(x3_3_11 - 1.0)*(x3_3_11 - 1.0) + 5.0d-1*(y3_3_11 - 1.0)*(y3_3_11
	- 1.0) + 5.0d-1*(x4_3_0 - 1.0)*(x4_3_0 - 1.0) + 5.0d-1*(y4_3_0 - 1.0)*(y4_3_0 -
	1.0) + 5.0d-1*(x4_3_11 - 1.0)*(x4_3_11 - 1.0) + 5.0d-1*(y4_3_11 - 1.0)*(y4_3_11
	- 1.0) + 5.0d-1*(x5_3_0 - 1.0)*(x5_3_0 - 1.0) + 5.0d-1*(y5_3_0 - 1.0)*(y5_3_0 -
	1.0) + 5.0d-1*(x5_3_11 - 1.0)*(x5_3_11 - 1.0) + 5.0d-1*(y5_3_11 - 1.0)*(y5_3_11
	- 1.0) + 5.0d-1*(x6_3_0 - 1.0)*(x6_3_0 - 1.0) + 5.0d-1*(y6_3_0 - 1.0)*(y6_3_0 -
	1.0) + 5.0d-1*(x6_3_11 - 1.0)*(x6_3_11 - 1.0) + 5.0d-1*(y6_3_11 - 1.0)*(y6_3_11
	- 1.0) + 5.0d-1*(x7_3_0 - 1.0)*(x7_3_0 - 1.0) + 5.0d-1*(y7_3_0 - 1.0)*(y7_3_0 -
	1.0) + 5.0d-1*(x7_3_11 - 1.0)*(x7_3_11 - 1.0) + 5.0d-1*(y7_3_11 - 1.0)*(y7_3_11
	- 1.0) + 5.0d-1*(x8_3_0 - 1.0)*(x8_3_0 - 1.0) + 5.0d-1*(y8_3_0 - 1.0)*(y8_3_0 -
	1.0) + 5.0d-1*(x8_3_11 - 1.0)*(x8_3_11 - 1.0) + 5.0d-1*(y8_3_11 - 1.0)*(y8_3_11
	- 1.0) + 5.0d-1*(x9_3_0 - 1.0)*(x9_3_0 - 1.0) + 5.0d-1*(y9_3_0 - 1.0)*(y9_3_0 -
	1.0) + 5.0d-1*(x9_3_11 - 1.0)*(x9_3_11 - 1.0) + 5.0d-1*(y9_3_11 - 1.0)*(y9_3_11
	- 1.0) + 5.0d-1*(x10_3_0 - 1.0)*(x10_3_0 - 1.0) + 5.0d-1*(y10_3_0 -
	1.0)*(y10_3_0 - 1.0) + 5.0d-1*(x10_3_11 - 1.0)*(x10_3_11 - 1.0) +
	5.0d-1*(y10_3_11 - 1.0)*(y10_3_11 - 1.0) + 5.0d-1*(x1_4_0 - 1.0)*(x1_4_0 - 1.0)
	+ 5.0d-1*(y1_4_0 - 1.0)*(y1_4_0 - 1.0) + 5.0d-1*(x1_4_11 - 1.0)*(x1_4_11 - 1.0)
	+ 5.0d-1*(y1_4_11 - 1.0)*(y1_4_11 - 1.0) + 5.0d-1*(x2_4_0 - 1.0)*(x2_4_0 - 1.0)
	+ 5.0d-1*(y2_4_0 - 1.0)*(y2_4_0 - 1.0) + 5.0d-1*(x2_4_11 - 1.0)*(x2_4_11 - 1.0)
	+ 5.0d-1*(y2_4_11 - 1.0)*(y2_4_11 - 1.0) + 5.0d-1*(x3_4_0 - 1.0)*(x3_4_0 - 1.0)
	+ 5.0d-1*(y3_4_0 - 1.0)*(y3_4_0 - 1.0) + 5.0d-1*(x3_4_11 - 1.0)*(x3_4_11 - 1.0)
	+ 5.0d-1*(y3_4_11 - 1.0)*(y3_4_11 - 1.0) + 5.0d-1*(x4_4_0 - 1.0)*(x4_4_0 - 1.0)
	+ 5.0d-1*(y4_4_0 - 1.0)*(y4_4_0 - 1.0) + 5.0d-1*(x4_4_11 - 1.0)*(x4_4_11 - 1.0)
	+ 5.0d-1*(y4_4_11 - 1.0)*(y4_4_11 - 1.0) + 5.0d-1*(x5_4_0 - 1.0)*(x5_4_0 - 1.0)
	+ 5.0d-1*(y5_4_0 - 1.0)*(y5_4_0 - 1.0) + 5.0d-1*(x5_4_11 - 1.0)*(x5_4_11 - 1.0)
	+ 5.0d-1*(y5_4_11 - 1.0)*(y5_4_11 - 1.0) + 5.0d-1*(x6_4_0 - 1.0)*(x6_4_0 - 1.0)
	+ 5.0d-1*(y6_4_0 - 1.0)*(y6_4_0 - 1.0) + 5.0d-1*(x6_4_11 - 1.0)*(x6_4_11 - 1.0)
	+ 5.0d-1*(y6_4_11 - 1.0)*(y6_4_11 - 1.0) + 5.0d-1*(x7_4_0 - 1.0)*(x7_4_0 - 1.0)
	+ 5.0d-1*(y7_4_0 - 1.0)*(y7_4_0 - 1.0) + 5.0d-1*(x7_4_11 - 1.0)*(x7_4_11 - 1.0)
	+ 5.0d-1*(y7_4_11 - 1.0)*(y7_4_11 - 1.0) + 5.0d-1*(x8_4_0 - 1.0)*(x8_4_0 - 1.0)
	+ 5.0d-1*(y8_4_0 - 1.0)*(y8_4_0 - 1.0) + 5.0d-1*(x8_4_11 - 1.0)*(x8_4_11 - 1.0)
	+ 5.0d-1*(y8_4_11 - 1.0)*(y8_4_11 - 1.0) + 5.0d-1*(x9_4_0 - 1.0)*(x9_4_0 - 1.0)
	+ 5.0d-1*(y9_4_0 - 1.0)*(y9_4_0 - 1.0) + 5.0d-1*(x9_4_11 - 1.0)*(x9_4_11 - 1.0)
	+ 5.0d-1*(y9_4_11 - 1.0)*(y9_4_11 - 1.0) + 5.0d-1*(x10_4_0 - 1.0)*(x10_4_0 -
	1.0) + 5.0d-1*(y10_4_0 - 1.0)*(y10_4_0 - 1.0) + 5.0d-1*(x10_4_11 -
	1.0)*(x10_4_11 - 1.0) + 5.0d-1*(y10_4_11 - 1.0)*(y10_4_11 - 1.0) +
	5.0d-1*(x1_5_0 - 1.0)*(x1_5_0 - 1.0) + 5.0d-1*(y1_5_0 - 1.0)*(y1_5_0 - 1.0) +
	5.0d-1*(x1_5_11 - 1.0)*(x1_5_11 - 1.0) + 5.0d-1*(y1_5_11 - 1.0)*(y1_5_11 - 1.0)
	+ 5.0d-1*(x2_5_0 - 1.0)*(x2_5_0 - 1.0) + 5.0d-1*(y2_5_0 - 1.0)*(y2_5_0 - 1.0) +
	5.0d-1*(x2_5_11 - 1.0)*(x2_5_11 - 1.0) + 5.0d-1*(y2_5_11 - 1.0)*(y2_5_11 - 1.0)
	+ 5.0d-1*(x3_5_0 - 1.0)*(x3_5_0 - 1.0) + 5.0d-1*(y3_5_0 - 1.0)*(y3_5_0 - 1.0) +
	5.0d-1*(x3_5_11 - 1.0)*(x3_5_11 - 1.0) + 5.0d-1*(y3_5_11 - 1.0)*(y3_5_11 - 1.0)
	+ 5.0d-1*(x4_5_0 - 1.0)*(x4_5_0 - 1.0) + 5.0d-1*(y4_5_0 - 1.0)*(y4_5_0 - 1.0) +
	5.0d-1*(x4_5_11 - 1.0)*(x4_5_11 - 1.0) + 5.0d-1*(y4_5_11 - 1.0)*(y4_5_11 - 1.0)
	+ 5.0d-1*(x5_5_0 - 1.0)*(x5_5_0 - 1.0) + 5.0d-1*(y5_5_0 - 1.0)*(y5_5_0 - 1.0) +
	5.0d-1*(x5_5_11 - 1.0)*(x5_5_11 - 1.0) + 5.0d-1*(y5_5_11 - 1.0)*(y5_5_11 - 1.0)
	+ 5.0d-1*(x6_5_0 - 1.0)*(x6_5_0 - 1.0) + 5.0d-1*(y6_5_0 - 1.0)*(y6_5_0 - 1.0) +
	5.0d-1*(x6_5_11 - 1.0)*(x6_5_11 - 1.0) + 5.0d-1*(y6_5_11 - 1.0)*(y6_5_11 - 1.0)
	+ 5.0d-1*(x7_5_0 - 1.0)*(x7_5_0 - 1.0) + 5.0d-1*(y7_5_0 - 1.0)*(y7_5_0 - 1.0) +
	5.0d-1*(x7_5_11 - 1.0)*(x7_5_11 - 1.0) + 5.0d-1*(y7_5_11 - 1.0)*(y7_5_11 - 1.0)
	+ 5.0d-1*(x8_5_0 - 1.0)*(x8_5_0 - 1.0) + 5.0d-1*(y8_5_0 - 1.0)*(y8_5_0 - 1.0) +
	5.0d-1*(x8_5_11 - 1.0)*(x8_5_11 - 1.0) + 5.0d-1*(y8_5_11 - 1.0)*(y8_5_11 - 1.0)
	+ 5.0d-1*(x9_5_0 - 1.0)*(x9_5_0 - 1.0) + 5.0d-1*(y9_5_0 - 1.0)*(y9_5_0 - 1.0) +
	5.0d-1*(x9_5_11 - 1.0)*(x9_5_11 - 1.0) + 5.0d-1*(y9_5_11 - 1.0)*(y9_5_11 - 1.0)
	+ 5.0d-1*(x10_5_0 - 1.0)*(x10_5_0 - 1.0) + 5.0d-1*(y10_5_0 - 1.0)*(y10_5_0 -
	1.0) + 5.0d-1*(x10_5_11 - 1.0)*(x10_5_11 - 1.0) + 5.0d-1*(y10_5_11 -
	1.0)*(y10_5_11 - 1.0) + 5.0d-1*(x1_6_0 - 1.0)*(x1_6_0 - 1.0) + 5.0d-1*(y1_6_0 -
	1.0)*(y1_6_0 - 1.0) + 5.0d-1*(x1_6_11 - 1.0)*(x1_6_11 - 1.0) + 5.0d-1*(y1_6_11
	- 1.0)*(y1_6_11 - 1.0) + 5.0d-1*(x2_6_0 - 1.0)*(x2_6_0 - 1.0) + 5.0d-1*(y2_6_0
	- 1.0)*(y2_6_0 - 1.0) + 5.0d-1*(x2_6_11 - 1.0)*(x2_6_11 - 1.0) +
	5.0d-1*(y2_6_11 - 1.0)*(y2_6_11 - 1.0) + 5.0d-1*(x3_6_0 - 1.0)*(x3_6_0 - 1.0) +
	5.0d-1*(y3_6_0 - 1.0)*(y3_6_0 - 1.0) + 5.0d-1*(x3_6_11 - 1.0)*(x3_6_11 - 1.0) +
	5.0d-1*(y3_6_11 - 1.0)*(y3_6_11 - 1.0) + 5.0d-1*(x4_6_0 - 1.0)*(x4_6_0 - 1.0) +
	5.0d-1*(y4_6_0 - 1.0)*(y4_6_0 - 1.0) + 5.0d-1*(x4_6_11 - 1.0)*(x4_6_11 - 1.0) +
	5.0d-1*(y4_6_11 - 1.0)*(y4_6_11 - 1.0) + 5.0d-1*(x5_6_0 - 1.0)*(x5_6_0 - 1.0) +
	5.0d-1*(y5_6_0 - 1.0)*(y5_6_0 - 1.0) + 5.0d-1*(x5_6_11 - 1.0)*(x5_6_11 - 1.0) +
	5.0d-1*(y5_6_11 - 1.0)*(y5_6_11 - 1.0) + 5.0d-1*(x6_6_0 - 1.0)*(x6_6_0 - 1.0) +
	5.0d-1*(y6_6_0 - 1.0)*(y6_6_0 - 1.0) + 5.0d-1*(x6_6_11 - 1.0)*(x6_6_11 - 1.0) +
	5.0d-1*(y6_6_11 - 1.0)*(y6_6_11 - 1.0) + 5.0d-1*(x7_6_0 - 1.0)*(x7_6_0 - 1.0) +
	5.0d-1*(y7_6_0 - 1.0)*(y7_6_0 - 1.0) + 5.0d-1*(x7_6_11 - 1.0)*(x7_6_11 - 1.0) +
	5.0d-1*(y7_6_11 - 1.0)*(y7_6_11 - 1.0) + 5.0d-1*(x8_6_0 - 1.0)*(x8_6_0 - 1.0) +
	5.0d-1*(y8_6_0 - 1.0)*(y8_6_0 - 1.0) + 5.0d-1*(x8_6_11 - 1.0)*(x8_6_11 - 1.0) +
	5.0d-1*(y8_6_11 - 1.0)*(y8_6_11 - 1.0) + 5.0d-1*(x9_6_0 - 1.0)*(x9_6_0 - 1.0) +
	5.0d-1*(y9_6_0 - 1.0)*(y9_6_0 - 1.0) + 5.0d-1*(x9_6_11 - 1.0)*(x9_6_11 - 1.0) +
	5.0d-1*(y9_6_11 - 1.0)*(y9_6_11 - 1.0) + 5.0d-1*(x10_6_0 - 1.0)*(x10_6_0 - 1.0)
	+ 5.0d-1*(y10_6_0 - 1.0)*(y10_6_0 - 1.0) + 5.0d-1*(x10_6_11 - 1.0)*(x10_6_11 -
	1.0) + 5.0d-1*(y10_6_11 - 1.0)*(y10_6_11 - 1.0) + 5.0d-1*(x1_7_0 - 1.0)*(x1_7_0
	- 1.0) + 5.0d-1*(y1_7_0 - 1.0)*(y1_7_0 - 1.0) + 5.0d-1*(x1_7_11 - 1.0)*(x1_7_11
	- 1.0) + 5.0d-1*(y1_7_11 - 1.0)*(y1_7_11 - 1.0) + 5.0d-1*(x2_7_0 - 1.0)*(x2_7_0
	- 1.0) + 5.0d-1*(y2_7_0 - 1.0)*(y2_7_0 - 1.0) + 5.0d-1*(x2_7_11 - 1.0)*(x2_7_11
	- 1.0) + 5.0d-1*(y2_7_11 - 1.0)*(y2_7_11 - 1.0) + 5.0d-1*(x3_7_0 - 1.0)*(x3_7_0
	- 1.0) + 5.0d-1*(y3_7_0 - 1.0)*(y3_7_0 - 1.0) + 5.0d-1*(x3_7_11 - 1.0)*(x3_7_11
	- 1.0) + 5.0d-1*(y3_7_11 - 1.0)*(y3_7_11 - 1.0) + 5.0d-1*(x4_7_0 - 1.0)*(x4_7_0
	- 1.0) + 5.0d-1*(y4_7_0 - 1.0)*(y4_7_0 - 1.0) + 5.0d-1*(x4_7_11 - 1.0)*(x4_7_11
	- 1.0) + 5.0d-1*(y4_7_11 - 1.0)*(y4_7_11 - 1.0) + 5.0d-1*(x5_7_0 - 1.0)*(x5_7_0
	- 1.0) + 5.0d-1*(y5_7_0 - 1.0)*(y5_7_0 - 1.0) + 5.0d-1*(x5_7_11 - 1.0)*(x5_7_11
	- 1.0) + 5.0d-1*(y5_7_11 - 1.0)*(y5_7_11 - 1.0) + 5.0d-1*(x6_7_0 - 1.0)*(x6_7_0
	- 1.0) + 5.0d-1*(y6_7_0 - 1.0)*(y6_7_0 - 1.0) + 5.0d-1*(x6_7_11 - 1.0)*(x6_7_11
	- 1.0) + 5.0d-1*(y6_7_11 - 1.0)*(y6_7_11 - 1.0) + 5.0d-1*(x7_7_0 - 1.0)*(x7_7_0
	- 1.0) + 5.0d-1*(y7_7_0 - 1.0)*(y7_7_0 - 1.0) + 5.0d-1*(x7_7_11 - 1.0)*(x7_7_11
	- 1.0) + 5.0d-1*(y7_7_11 - 1.0)*(y7_7_11 - 1.0) + 5.0d-1*(x8_7_0 - 1.0)*(x8_7_0
	- 1.0) + 5.0d-1*(y8_7_0 - 1.0)*(y8_7_0 - 1.0) + 5.0d-1*(x8_7_11 - 1.0)*(x8_7_11
	- 1.0) + 5.0d-1*(y8_7_11 - 1.0)*(y8_7_11 - 1.0) + 5.0d-1*(x9_7_0 - 1.0)*(x9_7_0
	- 1.0) + 5.0d-1*(y9_7_0 - 1.0)*(y9_7_0 - 1.0) + 5.0d-1*(x9_7_11 - 1.0)*(x9_7_11
	- 1.0) + 5.0d-1*(y9_7_11 - 1.0)*(y9_7_11 - 1.0) + 5.0d-1*(x10_7_0 -
	1.0)*(x10_7_0 - 1.0) + 5.0d-1*(y10_7_0 - 1.0)*(y10_7_0 - 1.0) +
	5.0d-1*(x10_7_11 - 1.0)*(x10_7_11 - 1.0) + 5.0d-1*(y10_7_11 - 1.0)*(y10_7_11 -
	1.0) + 5.0d-1*(x1_8_0 - 1.0)*(x1_8_0 - 1.0) + 5.0d-1*(y1_8_0 - 1.0)*(y1_8_0 -
	1.0) + 5.0d-1*(x1_8_11 - 1.0)*(x1_8_11 - 1.0) + 5.0d-1*(y1_8_11 - 1.0)*(y1_8_11
	- 1.0) + 5.0d-1*(x2_8_0 - 1.0)*(x2_8_0 - 1.0) + 5.0d-1*(y2_8_0 - 1.0)*(y2_8_0 -
	1.0) + 5.0d-1*(x2_8_11 - 1.0)*(x2_8_11 - 1.0) + 5.0d-1*(y2_8_11 - 1.0)*(y2_8_11
	- 1.0) + 5.0d-1*(x3_8_0 - 1.0)*(x3_8_0 - 1.0) + 5.0d-1*(y3_8_0 - 1.0)*(y3_8_0 -
	1.0) + 5.0d-1*(x3_8_11 - 1.0)*(x3_8_11 - 1.0) + 5.0d-1*(y3_8_11 - 1.0)*(y3_8_11
	- 1.0) + 5.0d-1*(x4_8_0 - 1.0)*(x4_8_0 - 1.0) + 5.0d-1*(y4_8_0 - 1.0)*(y4_8_0 -
	1.0) + 5.0d-1*(x4_8_11 - 1.0)*(x4_8_11 - 1.0) + 5.0d-1*(y4_8_11 - 1.0)*(y4_8_11
	- 1.0) + 5.0d-1*(x5_8_0 - 1.0)*(x5_8_0 - 1.0) + 5.0d-1*(y5_8_0 - 1.0)*(y5_8_0 -
	1.0) + 5.0d-1*(x5_8_11 - 1.0)*(x5_8_11 - 1.0) + 5.0d-1*(y5_8_11 - 1.0)*(y5_8_11
	- 1.0) + 5.0d-1*(x6_8_0 - 1.0)*(x6_8_0 - 1.0) + 5.0d-1*(y6_8_0 - 1.0)*(y6_8_0 -
	1.0) + 5.0d-1*(x6_8_11 - 1.0)*(x6_8_11 - 1.0) + 5.0d-1*(y6_8_11 - 1.0)*(y6_8_11
	- 1.0) + 5.0d-1*(x7_8_0 - 1.0)*(x7_8_0 - 1.0) + 5.0d-1*(y7_8_0 - 1.0)*(y7_8_0 -
	1.0) + 5.0d-1*(x7_8_11 - 1.0)*(x7_8_11 - 1.0) + 5.0d-1*(y7_8_11 - 1.0)*(y7_8_11
	- 1.0) + 5.0d-1*(x8_8_0 - 1.0)*(x8_8_0 - 1.0) + 5.0d-1*(y8_8_0 - 1.0)*(y8_8_0 -
	1.0) + 5.0d-1*(x8_8_11 - 1.0)*(x8_8_11 - 1.0) + 5.0d-1*(y8_8_11 - 1.0)*(y8_8_11
	- 1.0) + 5.0d-1*(x9_8_0 - 1.0)*(x9_8_0 - 1.0) + 5.0d-1*(y9_8_0 - 1.0)*(y9_8_0 -
	1.0) + 5.0d-1*(x9_8_11 - 1.0)*(x9_8_11 - 1.0) + 5.0d-1*(y9_8_11 - 1.0)*(y9_8_11
	- 1.0) + 5.0d-1*(x10_8_0 - 1.0)*(x10_8_0 - 1.0) + 5.0d-1*(y10_8_0 -
	1.0)*(y10_8_0 - 1.0) + 5.0d-1*(x10_8_11 - 1.0)*(x10_8_11 - 1.0) +
	5.0d-1*(y10_8_11 - 1.0)*(y10_8_11 - 1.0) + 5.0d-1*(x1_9_0 - 1.0)*(x1_9_0 - 1.0)
	+ 5.0d-1*(y1_9_0 - 1.0)*(y1_9_0 - 1.0) + 5.0d-1*(x1_9_11 - 1.0)*(x1_9_11 - 1.0)
	+ 5.0d-1*(y1_9_11 - 1.0)*(y1_9_11 - 1.0) + 5.0d-1*(x2_9_0 - 1.0)*(x2_9_0 - 1.0)
	+ 5.0d-1*(y2_9_0 - 1.0)*(y2_9_0 - 1.0) + 5.0d-1*(x2_9_11 - 1.0)*(x2_9_11 - 1.0)
	+ 5.0d-1*(y2_9_11 - 1.0)*(y2_9_11 - 1.0) + 5.0d-1*(x3_9_0 - 1.0)*(x3_9_0 - 1.0)
	+ 5.0d-1*(y3_9_0 - 1.0)*(y3_9_0 - 1.0) + 5.0d-1*(x3_9_11 - 1.0)*(x3_9_11 - 1.0)
	+ 5.0d-1*(y3_9_11 - 1.0)*(y3_9_11 - 1.0) + 5.0d-1*(x4_9_0 - 1.0)*(x4_9_0 - 1.0)
	+ 5.0d-1*(y4_9_0 - 1.0)*(y4_9_0 - 1.0) + 5.0d-1*(x4_9_11 - 1.0)*(x4_9_11 - 1.0)
	+ 5.0d-1*(y4_9_11 - 1.0)*(y4_9_11 - 1.0) + 5.0d-1*(x5_9_0 - 1.0)*(x5_9_0 - 1.0)
	+ 5.0d-1*(y5_9_0 - 1.0)*(y5_9_0 - 1.0) + 5.0d-1*(x5_9_11 - 1.0)*(x5_9_11 - 1.0)
	+ 5.0d-1*(y5_9_11 - 1.0)*(y5_9_11 - 1.0) + 5.0d-1*(x6_9_0 - 1.0)*(x6_9_0 - 1.0)
	+ 5.0d-1*(y6_9_0 - 1.0)*(y6_9_0 - 1.0) + 5.0d-1*(x6_9_11 - 1.0)*(x6_9_11 - 1.0)
	+ 5.0d-1*(y6_9_11 - 1.0)*(y6_9_11 - 1.0) + 5.0d-1*(x7_9_0 - 1.0)*(x7_9_0 - 1.0)
	+ 5.0d-1*(y7_9_0 - 1.0)*(y7_9_0 - 1.0) + 5.0d-1*(x7_9_11 - 1.0)*(x7_9_11 - 1.0)
	+ 5.0d-1*(y7_9_11 - 1.0)*(y7_9_11 - 1.0) + 5.0d-1*(x8_9_0 - 1.0)*(x8_9_0 - 1.0)
	+ 5.0d-1*(y8_9_0 - 1.0)*(y8_9_0 - 1.0) + 5.0d-1*(x8_9_11 - 1.0)*(x8_9_11 - 1.0)
	+ 5.0d-1*(y8_9_11 - 1.0)*(y8_9_11 - 1.0) + 5.0d-1*(x9_9_0 - 1.0)*(x9_9_0 - 1.0)
	+ 5.0d-1*(y9_9_0 - 1.0)*(y9_9_0 - 1.0) + 5.0d-1*(x9_9_11 - 1.0)*(x9_9_11 - 1.0)
	+ 5.0d-1*(y9_9_11 - 1.0)*(y9_9_11 - 1.0) + 5.0d-1*(x10_9_0 - 1.0)*(x10_9_0 -
	1.0) + 5.0d-1*(y10_9_0 - 1.0)*(y10_9_0 - 1.0) + 5.0d-1*(x10_9_11 -
	1.0)*(x10_9_11 - 1.0) + 5.0d-1*(y10_9_11 - 1.0)*(y10_9_11 - 1.0) +
	5.0d-1*(x1_10_0 - 1.0)*(x1_10_0 - 1.0) + 5.0d-1*(y1_10_0 - 1.0)*(y1_10_0 - 1.0)
	+ 5.0d-1*(x1_10_11 - 1.0)*(x1_10_11 - 1.0) + 5.0d-1*(y1_10_11 - 1.0)*(y1_10_11
	- 1.0) + 5.0d-1*(x2_10_0 - 1.0)*(x2_10_0 - 1.0) + 5.0d-1*(y2_10_0 -
	1.0)*(y2_10_0 - 1.0) + 5.0d-1*(x2_10_11 - 1.0)*(x2_10_11 - 1.0) +
	5.0d-1*(y2_10_11 - 1.0)*(y2_10_11 - 1.0) + 5.0d-1*(x3_10_0 - 1.0)*(x3_10_0 -
	1.0) + 5.0d-1*(y3_10_0 - 1.0)*(y3_10_0 - 1.0) + 5.0d-1*(x3_10_11 -
	1.0)*(x3_10_11 - 1.0) + 5.0d-1*(y3_10_11 - 1.0)*(y3_10_11 - 1.0) +
	5.0d-1*(x4_10_0 - 1.0)*(x4_10_0 - 1.0) + 5.0d-1*(y4_10_0 - 1.0)*(y4_10_0 - 1.0)
	+ 5.0d-1*(x4_10_11 - 1.0)*(x4_10_11 - 1.0) + 5.0d-1*(y4_10_11 - 1.0)*(y4_10_11
	- 1.0) + 5.0d-1*(x5_10_0 - 1.0)*(x5_10_0 - 1.0) + 5.0d-1*(y5_10_0 -
	1.0)*(y5_10_0 - 1.0) + 5.0d-1*(x5_10_11 - 1.0)*(x5_10_11 - 1.0) +
	5.0d-1*(y5_10_11 - 1.0)*(y5_10_11 - 1.0) + 5.0d-1*(x6_10_0 - 1.0)*(x6_10_0 -
	1.0) + 5.0d-1*(y6_10_0 - 1.0)*(y6_10_0 - 1.0) + 5.0d-1*(x6_10_11 -
	1.0)*(x6_10_11 - 1.0) + 5.0d-1*(y6_10_11 - 1.0)*(y6_10_11 - 1.0) +
	5.0d-1*(x7_10_0 - 1.0)*(x7_10_0 - 1.0) + 5.0d-1*(y7_10_0 - 1.0)*(y7_10_0 - 1.0)
	+ 5.0d-1*(x7_10_11 - 1.0)*(x7_10_11 - 1.0) + 5.0d-1*(y7_10_11 - 1.0)*(y7_10_11
	- 1.0) + 5.0d-1*(x8_10_0 - 1.0)*(x8_10_0 - 1.0) + 5.0d-1*(y8_10_0 -
	1.0)*(y8_10_0 - 1.0) + 5.0d-1*(x8_10_11 - 1.0)*(x8_10_11 - 1.0) +
	5.0d-1*(y8_10_11 - 1.0)*(y8_10_11 - 1.0) + 5.0d-1*(x9_10_0 - 1.0)*(x9_10_0 -
	1.0) + 5.0d-1*(y9_10_0 - 1.0)*(y9_10_0 - 1.0) + 5.0d-1*(x9_10_11 -
	1.0)*(x9_10_11 - 1.0) + 5.0d-1*(y9_10_11 - 1.0)*(y9_10_11 - 1.0) +
	5.0d-1*(x10_10_0 - 1.0)*(x10_10_0 - 1.0) + 5.0d-1*(y10_10_0 - 1.0)*(y10_10_0 -
	1.0) + 5.0d-1*(x10_10_11 - 1.0)*(x10_10_11 - 1.0) + 5.0d-1*(y10_10_11 -
	1.0)*(y10_10_11 - 1.0);

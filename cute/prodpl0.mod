...
subject to smooth1:
	0 >= ((x00302+x00402)-x00301+x00401)^2 - ((0.1)*0.1) * (x00301+x00401)^2;
subject to smooth2:
	0 >= ((x00303+x00403)-x00302+x00402)^2 - ((0.1)*0.1) * (x00302+x00402)^2;
subject to smooth3:
	0 >= ((x00304+x00404)-x00303+x00403)^2 - ((0.1)*0.1) * (x00303+x00403)^2;
subject to smooth4:
	0 >= ((x00305+x00405)-x00304+x00404)^2 - ((0.1)*0.1) * (x00304+x00404)^2;
